...
from mishikallm_proxy_extras._logging import logger
...
class ProxyExtrasDBManager:
    ...
    def _get_prisma_dir() -> str:
        ...
        Set os.environ["MISHIKALLM_MIGRATION_DIR"] to a custom migrations directory, to support baselining db in read-only fs.
        """
        custom_migrations_dir = os.getenv("MISHIKALLM_MIGRATION_DIR")
    ...
    def _resolve_all_migrations(migrations_dir: str, schema_path: str):
        ...
        try:
            ...
            if "Permission denied" in str(e):
                logger.warning(
                    f"Permission denied - {e}\nunable to baseline db. Set MISHIKALLM_MIGRATION_DIR environment variable to a writable directory to enable migrations."
                )
                return
            raise e
    ...
    def setup_database(use_migrate: bool = False) -> bool:
        ...
        Uses migrations from mishikallm-proxy-extras package
