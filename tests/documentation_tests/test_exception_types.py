...
public_exceptions = mishikallm.MISHIKALLM_EXCEPTION_TYPES
...
if undocumented_keys:
    raise Exception(
        f"\nKeys not documented in 'MishikaLLM Exceptions': {undocumented_keys}"
    )
else:
    print("\nAll keys are documented in 'MishikaLLM Exceptions'. - {}".format(error_names))
