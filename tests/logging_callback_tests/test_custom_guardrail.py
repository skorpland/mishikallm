...
from mishikallm.proxy.guardrails.guardrail_endpoints import _get_guardrails_list_response
from mishikallm.types.guardrails import GuardrailInfoResponse, ListGuardrailsResponse
    ...
    minimal_config = [
        {
            ...
            "mishikallm_params": {"guardrail": "minimal-guard", "mode": "pre_call"},
        }
    ]
