...
def test_spend_logs_payload(model_id: Optional[str]):
    ...
    input_args: dict = {
        "kwargs": {
            ...
            "mishikallm_params": {
                ...
                "mishikallm_call_id": "b9929bf6-7b80-4c8c-b486-034e6ac0c8b7",
                "model_alias_map": {},
    ...
    # This is crucial - used in PROD, it should pass, related issue: https://github.com/skorpland/mishikallm/issues/4334
    assert (
...
def test_spend_logs_payload_whisper():
    ...
    kwargs: dict = {
        ...
        "mishikallm_params": {
            ...
            "metadata": {
                ...
                "user_api_key_end_user_id": "test-user",
                "user_api_end_user_max_budget": None,
                "mishikallm_api_version": "1.40.19",
                "global_max_parallel_requests": None,
        ...
        "mishikallm_call_id": "05921cf7-33f9-421c-aad9-33310c1e2702",
    ...
    response = mishikallm.utils.TranscriptionResponse(
...
def test_spend_logs_payload_with_prompts_enabled(monkeypatch):
        ...
        "response_obj": mishikallm.ModelResponse(
            ...
            choices=[
                mishikallm.Choices(
                    finish_reason="stop",
                    index=0,
                    message=mishikallm.Message(content="Hi there!", role="assistant"),
                )
            ],
            model="gpt-3.5-turbo",
            usage=mishikallm.Usage(completion_tokens=2, prompt_tokens=1, total_tokens=3),
        ),
        "start_time": datetime.datetime.now(),
        "end_time": datetime.datetime.now(),
    }
    ...
    input_args["kwargs"]["mishikallm_params"] = mishikallm_params
