...
import pytest
from mishikallm.integrations.langfuse.langfuse import (
    LangFuseLogger,
)
from mishikallm.integrations.langfuse.langfuse_handler import LangFuseHandler
...
def test_langfuse_e2e_sync(monkeypatch):
    ...
    monkeypatch.setattr(mishikallm, "success_callback", ["langfuse"])
    ...
    with respx.mock:
        ...
        completion(
            ...
            stream=False,
            mock_response="Hello from mishikallm 2",
        )
