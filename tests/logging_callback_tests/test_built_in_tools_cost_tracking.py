...
from mishikallm.mishikallm_core_utils.llm_cost_calc.tool_call_cost_tracking import StandardBuiltInToolCostTracking
...
async def test_openai_web_search_logging_cost_tracking(
    ...
    response = await mishikallm.acompletion(**request_kwargs)
