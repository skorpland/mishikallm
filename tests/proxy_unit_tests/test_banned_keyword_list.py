...
import pytest
import mishikallm
from mishikallm.proxy.enterprise.enterprise_hooks.banned_keywords import (
...
async def test_banned_keywords_check():
    """
    - Set some banned keywords as a mishikallm module value
    ...
    """
    mishikallm.banned_keywords_list = ["hello"]
