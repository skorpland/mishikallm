...
import mishikallm
from mishikallm.proxy._types import MishikaLLMRoutes
from mishikallm.proxy.auth.auth_utils import get_request_route
...
def test_routes_on_mishikallm_proxy():
    """
    ...
    print("ALL ROUTES on MishikaLLM Proxy:", _all_routes)
    print("\n\n")
    print("ALL OPENAI ROUTES:", MishikaLLMRoutes.openai_routes.value)

    for route in MishikaLLMRoutes.openai_routes.value:
