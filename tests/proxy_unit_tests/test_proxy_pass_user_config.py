...
def test_chat_completion(client_no_auth):
    ...
    from mishikallm.types.router import RouterConfig, ModelConfig
    from mishikallm.types.completion import CompletionRequest

    user_config = RouterConfig(
        model_list=[
            ModelConfig(
                model_name="user-azure-instance",
                mishikallm_params=CompletionRequest(
