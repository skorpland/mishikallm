...
async def test_anthropic_basic_completion_with_headers():
    ...
    async with aiohttp.ClientSession() as session:
        async with session.post(
            ...
            mishikallm_call_id = response_headers.get("x-mishikallm-call-id")
            ...
            async with session.get(
                f"http://0.0.0.0:4000/spend/logs?request_id={mishikallm_call_id}",
                ...
                assert (
                    log_entry["request_id"] == mishikallm_call_id
