...
@pytest.mark.asyncio
async def test_mishikallm_anthropic_prompt_caching_tools():
    ...
    with patch(
        ...
        # Act: Call the mishikallm.acompletion function
...
async def test_anthropic_api_prompt_caching_with_content_str():
    ...
    translated_system_message = mishikallm.AnthropicConfig().translate_system_message(
...
@pytest.mark.asyncio
async def test_mishikallm_anthropic_prompt_caching_system():
...
def test_is_prompt_caching_enabled(anthropic_messages):
    assert mishikallm.utils.is_prompt_caching_valid_prompt(
        messages=anthropic_messages,
        tools=None,
...
async def test_router_prompt_caching_model_stored(
    ...
    from mishikallm.router_utils.prompt_caching_cache import PromptCachingCache
