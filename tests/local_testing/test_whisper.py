# What is this?
## Tests `mishikallm.transcription` endpoint. Outside mishikallm module b/c of audio file used in testing (it's ~700kb).
...
async def test_transcription(
    ...
    transcript = await mishikallm.atranscription(
        model=model,
        file=audio_file,
        api_key=api_key,
        api_base=api_base,
...
async def test_transcription_caching():
    ...
    response_1 = await mishikallm.atranscription(
        model="whisper-1",
        file=audio_file,
    )
    ...
    response_2 = await mishikallm.atranscription(
        model="whisper-1",
        file=audio_file,
    )
    ...
    response_3 = await mishikallm.atranscription(
        model="whisper-1",
        file=audio_file2,
    )
