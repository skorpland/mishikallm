...
from mishikallm.router_strategy.lowest_tpm_rpm_v2 import (
...
def test_tpm_rpm_updated():
    ...
    standard_logging_payload["hidden_params"]["mishikallm_model_name"] = deployment
    kwargs = {
        "mishikallm_params": {
            "model": deployment,
            "metadata": {
    ...
    mishikallm_deployment_dict: DeploymentTypedDict = {
        "model_name": model_group,
        "mishikallm_params": {"model": deployment},
        "model_info": {"id": deployment_id},
    }
    ...
    end_time = time.time()
    lowest_tpm_logger.pre_call_check(deployment=mishikallm_deployment_dict)
    ...
    model_list = [
        {
            ...
            "mishikallm_params": {"model": "azure/chatgpt-v-3"},
            "model_info": {"id": "1234"},
        },
        {
            "model_name": "gpt-3.5-turbo",
...
def test_router_get_available_deployments():
    ...
    total_tokens = 50
    standard_logging_payload["total_tokens"] = total_tokens
    standard_logging_payload["hidden_params"]["mishikallm_model_name"] = "azure/gpt-turbo"
    kwargs = {
        "mishikallm_params": {
            "metadata": {
...
async def test_tpm_rpm_routing_model_name_checks():
    ...
    with patch.object(
        ...
        assert (
            mock_object.call_args[0][0]["mishikallm_params"]["model"]
            == deployment["mishikallm_params"]["model"]
        )
        ...
        assert (
            standard_logging_payload["hidden_params"]["mishikallm_model_name"]
            == "azure/chatgpt-v-3"
        )
