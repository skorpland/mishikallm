...
def test_multiple_deployments_parallel():
    mishikallm.set_verbose = False  # Corrected the syntax for setting verbose to False
    results = []
    futures = {}
...
# Assuming mishikallm, router, and executor are defined somewhere in your code
...
async def test_cooldown_same_model_name(sync_mode):
    ...
    try:
        ...
        if sync_mode:
            ...
            print("\n mishikallm model ids ", model_ids)

            # example mishikallm_model_names ['azure/chatgpt-v-3-ModelID-64321', 'azure/chatgpt-v-3-ModelID-63960']
            assert (
