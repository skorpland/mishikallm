...
def test_router_timeouts():
    ...
    for question in questions_list:
        ...
        prompt_tokens = mishikallm.token_counter(text=question["content"], model="gpt-4")
...
def test_router_timeout_with_retries_anthropic_model(num_retries, expected_call_count):
    ...
    mishikallm.num_retries = num_retries
    mishikallm.request_timeout = 0.000001
...
def test_router_stream_timeout(model):
    ...
    from dotenv import load_dotenv
    import mishikallm
    from mishikallm.router import Router, RetryPolicy, AllowedFailsPolicy
