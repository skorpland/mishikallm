...
import mishikallm
from mishikallm import RateLimitError, completion
...
#     mishikallm.HuggingfaceConfig(max_new_tokens=200)
#     mishikallm.set_verbose=True
#     try:
#         # OVERRIDE WITH DYNAMIC MAX TOKENS
#         response_1 = mishikallm.completion(
...
#         # USE CONFIG TOKENS
#         response_2 = mishikallm.completion(
#             model="huggingface/mistralai/Mistral-7B-Instruct-v0.1",
#             messages=[{ "content": "Hello, how are you?","role": "user"}],
#             api_base="https://n9ox93a8sv5ihsow.us-east-1.aws.endpoints.huggingface.cloud",
#         )
...
def claude_test_completion():
    mishikallm.AnthropicConfig(max_tokens_to_sample=200)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
        ...
        try:
            response_3 = mishikallm.completion(
...
def replicate_test_completion():
    mishikallm.ReplicateConfig(max_new_tokens=200)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def cohere_test_completion():
    # mishikallm.CohereConfig(max_tokens=200)
    mishikallm.set_verbose = True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def togetherai_test_completion():
    mishikallm.TogetherAIConfig(max_tokens=10)
    mishikallm.set_verbose = True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def nlp_cloud_test_completion():
    mishikallm.NLPCloudConfig(max_length=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def aleph_alpha_test_completion():
    mishikallm.AlephAlphaConfig(maximum_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
#     mishikallm.PetalsConfig(max_new_tokens=10)
#     # mishikallm.set_verbose=True
#     try:
#         # OVERRIDE WITH DYNAMIC MAX TOKENS
#         response_1 = mishikallm.completion(
...
#     mishikallm.VertexAIConfig(max_output_tokens=10)
#     # mishikallm.set_verbose=True
#     try:
#         # OVERRIDE WITH DYNAMIC MAX TOKENS
#         response_1 = mishikallm.completion(
...
def sagemaker_test_completion():
    mishikallm.SagemakerConfig(max_new_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def bedrock_test_completion():
    mishikallm.AmazonCohereConfig(max_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def openai_test_completion():
    mishikallm.OpenAIConfig(max_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def openai_text_completion_test():
    mishikallm.OpenAITextCompletionConfig(max_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
...
def azure_openai_test_completion():
    mishikallm.AzureOpenAIConfig(max_tokens=10)
    # mishikallm.set_verbose=True
    try:
        # OVERRIDE WITH DYNAMIC MAX TOKENS
        response_1 = mishikallm.completion(
