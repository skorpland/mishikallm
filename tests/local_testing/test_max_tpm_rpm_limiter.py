...
# from mishikallm.proxy.hooks.tpm_rpm_limiter import _PROXY_MaxTPMRPMLimiter
# from datetime import datetime
...
#     cache_params = {"type": "redis", "namespace": "mishikallm_default"}

#     ## INIT CACHE ##
#     proxy_config = ProxyConfig()
#     setattr(mishikallm.proxy.proxy_server, "proxy_config", proxy_config)

#     proxy_config._init_cache(cache_params=cache_params)

#     redis_cache: Optional[RedisCache] = getattr(
#         mishikallm.proxy.proxy_server, "redis_usage_cache"
#     )

#     ## CHECK IF NAMESPACE SET ##
#     assert redis_cache.namespace == "mishikallm_default"
...
#     cache_key = "mishikallm_default:usage:{}".format(precise_minute)
