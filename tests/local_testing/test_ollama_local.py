...
#     response = await mishikallm.aembedding(model="ollama/mistral", input=input)
#     print(response)
...
#     mishikallm.set_verbose = True
#     input = "The food was delicious and the waiter..."
#     response = mishikallm.embedding(model="ollama/mistral", input=input)
#     print(response)
...
#             }
#         ]
#         response = mishikallm.completion(model="ollama/mistral",
#                                              messages=messages,
#                                              functions=functions,
#                                              stream=True)
...
#     try:
#         mishikallm.set_verbose = False
#         response = await mishikallm.acompletion(model="ollama/mistral-openorca",
...
#     params = {
#         "messages": prepare_messages_for_chat("What is mishikallm? tell me 10 things about it who is sihaan.write an essay"),
#         "api_base": "http://localhost:11434",
#         "model": "ollama/llama2",
#         "stream": True,
#     }
#     response = await mishikallm.acompletion(**params)
#     return response
...
#     response = await mishikallm.acompletion(
#         model="ollama/llama2",
#         messages=prepare_messages_for_chat("What is mishikallm? respond in 2 words"),
#     )
