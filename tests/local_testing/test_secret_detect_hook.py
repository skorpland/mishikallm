...
from mishikallm.proxy.enterprise.enterprise_hooks.secret_detection import (
...
async def test_chat_completion_request_with_redaction():
    ...
    Makes a /chat/completions request on MishikaLLM Proxy
    ...
    mishikallm.callbacks = [_ENTERPRISE_SecretDetection(), _test_logger]
