...
from mishikallm.types.utils import GenericBudgetConfigType, BudgetConfig
...
async def test_get_llm_provider_for_deployment():
    ...
    openai_deployment = {"mishikallm_params": {"model": "openai/gpt-4"}}
    assert (
...
async def test_prometheus_metric_tracking():
    ...
    mishikallm._async_success_callback = [mock_prometheus]
