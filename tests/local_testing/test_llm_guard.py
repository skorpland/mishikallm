...
import pytest
import mishikallm
from mishikallm.proxy.enterprise.enterprise_hooks.llm_guard import _ENTERPRISE_LLMGuard
...
def test_llm_guard_key_specific_mode():
    ...
    """
    mishikallm.llm_guard_mode = "key-specific"
...
def test_llm_guard_request_specific_mode():
    ...
    """
    mishikallm.llm_guard_mode = "request-specific"
