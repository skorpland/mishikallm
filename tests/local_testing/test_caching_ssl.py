#### What this tests ####
#    This tests using caching w/ mishikallm which requires SSL=True
...
import pytest
import mishikallm
from mishikallm import embedding, completion, Router
...
def test_caching_router():
    """
    Test scenario where mishikallm.cache is set but kwargs("caching") is not. This should still return a cache hit.
    """
    try:
        model_list = [
            {
...
async def test_redis_with_ssl():
    ...
    """
    from mishikallm._redis import get_redis_connection_pool, get_redis_async_client
