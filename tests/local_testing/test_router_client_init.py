...
import mishikallm
from mishikallm import APIConnectionError, Router
...
@patch("mishikallm.secret_managers.get_azure_ad_token_provider.os")
...
async def test_audio_speech_router():
    """
    Test that router uses OpenAI/Azure OpenAI Client initialized during init for mishikallm.aspeech
    """
    ...
    with patch("mishikallm.aspeech") as mock_aspeech:
        ...
        print(
            "mishikallm.aspeech was called with kwargs = ", mock_aspeech.call_args.kwargs
        )
