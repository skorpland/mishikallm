...
async def test_audio_speech_mishikallm(sync_mode, model, api_base, api_key):
...
@pytest.mark.asyncio
@pytest.mark.flaky(retries=3, delay=1)
async def test_audio_speech_mishikallm_vertex(sync_mode):
...
@pytest.mark.asyncio
async def test_speech_mishikallm_vertex_async():
    # Mock the response
...
@pytest.mark.asyncio
async def test_speech_mishikallm_vertex_async_with_voice():
    # Mock the response
    mock_response = AsyncMock()
...
@pytest.mark.asyncio
async def test_speech_mishikallm_vertex_async_with_voice_ssml():
    # Mock the response
    mock_response = AsyncMock()
