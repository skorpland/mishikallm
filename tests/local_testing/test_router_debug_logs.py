...
# this tests debug logs from mishikallm router and mishikallm proxy server
from mishikallm._logging import verbose_logger, verbose_proxy_logger, verbose_router_logger


# this tests debug logs from mishikallm router and mishikallm proxy server
def test_async_fallbacks(caplog):
    # THIS IS A PROD TEST - DO NOT DELETE THIS. Used for testing if mishikallm proxy verbose logs are human readable
    ...
    expected_logs = [
        ...
        "mishikallm.acompletion(model=azure/chatgpt-v-3)\x1b[32m 200 OK\x1b[0m",
