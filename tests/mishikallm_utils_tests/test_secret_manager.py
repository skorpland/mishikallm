...
import pytest
import mishikallm
from mishikallm.llms.azure.azure import get_azure_ad_token_from_oidc
from mishikallm.llms.bedrock.chat import BedrockConverseLLM, BedrockLLM
...
def test_aws_secret_manager():
    ...
    secret_val = get_secret("mishikallm_master_key")
    ...
    assert secret_val["mishikallm_master_key"] == "sk-1234"
...
def test_oidc_circle_v1_with_amazon():
    ...
    aws_role_name = "arn:aws:iam::335785316107:role/mishikallm-github-unit-tests-circleci-v1-assume-only"
...
def test_google_secret_manager():
    ...
    from mishikallm.secret_managers.google_secret_manager import GoogleSecretManager
...
def test_should_read_secret_from_secret_manager():
    ...
    """
    from mishikallm.proxy._types import KeyManagementSettings

    # Test when secret manager client is None
    mishikallm.secret_manager_client = None
    ...
    mishikallm.secret_manager_client = "dummy_client"
    mishikallm._key_management_settings = KeyManagementSettings(access_mode="read_only")
    ...
    mishikallm._key_management_settings = KeyManagementSettings(access_mode="write_only")
    assert _should_read_secret_from_secret_manager() is False
