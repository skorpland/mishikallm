...
def test_image_generation_openai_with_pydantic_warning(caplog):
    try:
        import logging
        from mishikallm.types.utils import ImageResponse, ImageObject
