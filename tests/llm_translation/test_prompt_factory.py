...
def test_bedrock_parallel_tool_calling_pt(provider):
    """
    Make sure parallel tool call blocks are merged correctly - https://github.com/skorpland/mishikallm/issues/5277
    """
    from mishikallm.mishikallm_core_utils.prompt_templates.factory import (
...
def test_azure_tool_call_invoke_helper():
    ...
    transformed_messages = mishikallm.AzureOpenAIConfig().transform_request(
        model="gpt-4o",
        messages=messages,
        optional_params={},
        mishikallm_params={},
...
def test_ollama_pt():
    from mishikallm.mishikallm_core_utils.prompt_templates.factory import ollama_pt
