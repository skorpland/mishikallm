...
def test_dynamic_aws_params_propagation(model, param_name, param_value):
    """
    When passed to mishikallm.completion, each dynamic AWS authentication parameter
    ...
    with patch("botocore.auth.SigV4Auth", autospec=True) as mock_sigv4:
        ...
        with patch.object(
            ...
            with patch.object(client, "post") as mock_post:
                ...
                # Call mishikallm.completion with our base & dynamic parameters.
                mishikallm.completion(**base_params)
