...
def test_convert_chat_to_text_completion():
    ...
    result = MishikaLLMResponseObjectHandler.convert_chat_to_text_completion(
...
def test_convert_provider_response_logprobs_non_huggingface():
    ...
    result = MishikaLLMResponseObjectHandler._convert_provider_response_logprobs_to_text_completion_logprobs(
