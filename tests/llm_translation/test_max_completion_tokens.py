...
def test_all_model_configs():
    from mishikallm.llms.vertex_ai.vertex_ai_partner_models.ai21.transformation import (
        VertexAIAi21Config,
    )
    from mishikallm.llms.vertex_ai.vertex_ai_partner_models.llama3.transformation import (
    ...
    from mishikallm.llms.fireworks_ai.chat.transformation import (
        FireworksAIConfig,
    )
    ...
    from mishikallm.llms.nvidia_nim.chat import NvidiaNimConfig
    ...
    from mishikallm.llms.ollama_chat import OllamaChatConfig
    ...
    from mishikallm.llms.predibase.chat.transformation import PredibaseConfig
    ...
    from mishikallm.llms.codestral.completion.transformation import (
    ...
    from mishikallm.llms.volcengine import VolcEngineConfig
    ...
    from mishikallm.llms.ai21.chat.transformation import AI21ChatConfig
    ...
    from mishikallm.llms.azure.chat.gpt_transformation import AzureOpenAIConfig
    ...
    from mishikallm.llms.databricks.chat.transformation import DatabricksConfig
    ...
    from mishikallm.llms.vertex_ai.vertex_ai_partner_models.anthropic.transformation import (
    ...
    from mishikallm.llms.gemini.chat.transformation import GoogleAIStudioGeminiConfig
