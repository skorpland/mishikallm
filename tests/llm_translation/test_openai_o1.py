...
async def test_o1_handle_system_role(model):
    ...
    from mishikallm.utils import supports_system_messages
...
def test_o1_supports_vision():
    ...
    for k, v in mishikallm.model_cost.items():
        if k.startswith("o1") and v.get("mishikallm_provider") == "openai":
