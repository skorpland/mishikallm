...
import mishikallm
from mishikallm import Choices, Message, ModelResponse, EmbeddingResponse, Usage
from mishikallm import completion
from unittest.mock import patch
from mishikallm.llms.xai.chat.transformation import XAIChatConfig, XAI_API_BASE
    ...
    try:
        ...
        if stream is True:
            for chunk in response:
                ...
                assert isinstance(chunk.choices[0], mishikallm.utils.StreamingChoices)
