...
def test_map_azure_model_group(model_group_header, expected_model):
    from mishikallm.llms.azure_ai.embed.cohere_transformation import AzureAICohereConfig
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://mishikallm8397336933.services.ai.azure.com/models/chat/completions",
            "https://mishikallm8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
            "https://mishikallm8397336933.services.ai.azure.com/models",
            "https://mishikallm8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
    ...
    with patch.object(client, "post") as mock_client:
        try:
            response = mishikallm.completion(
                ...
                api_base="https://mishikallm8397336933.services.ai.azure.com/models",
                client=client,
            )
        except Exception as e:
            print(f"Error: {e}")
...
def test_azure_deepseek_reasoning_content():
    ...
    with patch.object(client, "post") as mock_post:
        ...
        response = mishikallm.completion(
            ...
            api_base="https://mishikallm8397336933.services.ai.azure.com/models/chat/completions",
            api_key="my-fake-api-key",
            client=client,
        )
...
#         return mishikallm.LlmProviders.AZURE_AI
