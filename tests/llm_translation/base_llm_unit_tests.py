...
from mishikallm.types.utils import Usage, ModelResponse
# test_example.py
from abc import ABC, abstractmethod
from openai import OpenAI


def _usage_format_tests(usage: mishikallm.Usage):
    """
...
class BaseLLMChatTest(ABC):
    ...
    def test_streaming(self):
        """Check if mishikallm handles streaming correctly"""
        base_completion_call_args = self.get_base_completion_call_args()
        ...
        resp = mishikallm.stream_chunk_builder(chunks=chunks)
        print(resp)
    ...
    def test_pydantic_model_input(self):
        ...
        from mishikallm import completion, Message
    ...
    def test_file_data_unit_test(self, pdf_messages):
        from mishikallm.utils import supports_pdf_input, return_raw_request
        from mishikallm.types.utils import CallTypes
        from mishikallm.mishikallm_core_utils.prompt_templates.factory import convert_to_anthropic_image_obj
    ...
    def test_response_format_type_text_with_tool_calls_no_tool_choice(
        ...
        try:
            ...
            print(f"RESPONSE={response}")
        except mishikallm.ContextWindowExceededError:
    ...
    def test_response_format_type_text(self):
        ...
        """
        from mishikallm import LlmProviders

        base_completion_call_args = self.get_base_completion_call_args()
        mishikallm.set_verbose = True

        _, provider, _, _ = mishikallm.get_llm_provider(
    ...
    def test_json_response_nested_json_schema(self):
        ...
        from pydantic import BaseModel
        from mishikallm.utils import supports_response_schema
        from mishikallm.llms.base_llm.base_utils import type_to_response_format_param
    ...
    def test_empty_tools(self):
        """
        Related Issue: https://github.com/skorpland/mishikallm/issues/9080
        """
        try:
            from mishikallm import completion, ModelResponse
    ...
    def test_supports_audio_input(self, input_type, format_specified):
        from mishikallm.utils import return_raw_request, supports_audio_input
        from mishikallm.types.utils import CallTypes
        os.environ["MISHIKALLM_LOCAL_MODEL_COST_MAP"] = "True"
        mishikallm.model_cost = mishikallm.get_model_cost_map(url="")
    ...
    def test_reasoning_effort(self):
        ...
        from mishikallm.utils import supports_reasoning
        from mishikallm import completion
