...
def main():
    # router_file = [
    #     "./mishikallm/user_api_key_auth.py",
    # ]
    router_file = [
        "../../mishikallm/proxy/auth/user_api_key_auth.py",
    ]
    # router_file = [
    #     "../../mishikallm/router.py",
    #     "../../mishikallm/router_utils/pattern_match_deployments.py",
    #     "../../mishikallm/router_utils/batch_utils.py",
    # ]  ## LOCAL TESTING
    # tests_dir = (
