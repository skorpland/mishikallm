...
from mishikallm.constants import MAX_SIZE_IN_MEMORY_QUEUE
from mishikallm.proxy._types import Mishikallm_EntityType, SpendUpdateQueueItem
...
async def test_multiple_updates_with_missing_fields(spend_queue):
    ...
    updates: list[SpendUpdateQueueItem] = [
        ...
        {
            "entity_type": Mishikallm_EntityType.USER,  # missing entity_id
            "response_cost": 1.5,
        },
    ]
