...
from mishikallm.proxy._types import DefaultInternalUserParams, MishikallmUserRoles
...
def mock_auth(monkeypatch):
    ...
    monkeypatch.setattr(
        "mishikallm.proxy.ui_crud_endpoints.proxy_setting_endpoints.user_api_key_auth",
...
class TestProxySettingEndpoints:
    ...
    def test_get_internal_user_settings(self, mock_proxy_config, mock_auth):
        ...
        values = data["values"]
        mock_params = mock_proxy_config["config"]["mishikallm_settings"][
            "default_internal_user_params"
        ]
    ...
    def test_update_internal_user_settings(
        ...
        # Mock mishikallm.default_internal_user_params
        import mishikallm

        monkeypatch.setattr(mishikallm, "default_internal_user_params", {})
        ...
        updated_config = mock_proxy_config["config"]["mishikallm_settings"][
            "default_internal_user_params"
        ]
    ...
    def test_update_default_team_settings(
        ...
        # Mock mishikallm.default_team_params
        import mishikallm

        monkeypatch.setattr(mishikallm, "default_team_params", {})
