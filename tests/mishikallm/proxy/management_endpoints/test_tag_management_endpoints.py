...
from mishikallm.types.tag_management import TagDeleteRequest, TagInfoRequest, TagNewRequest
...
async def test_create_and_get_tag():
    ...
    with patch("mishikallm.proxy.proxy_server.prisma_client") as mock_prisma, patch(
        "mishikallm.proxy.management_endpoints.tag_management_endpoints._get_tags_config"
    ) as mock_get_tags, patch(
        "mishikallm.proxy.management_endpoints.tag_management_endpoints._save_tags_config"
    ) as mock_save_tags, patch(
        "mishikallm.proxy.management_endpoints.tag_management_endpoints._add_tag_to_deployment"
    ) as mock_add_tag, patch(
        "mishikallm.proxy.management_endpoints.tag_management_endpoints._get_model_names"
    ) as mock_get_models:
        # Setup mocks
