...
from mishikallm.proxy._types import MishikaLLM_TeamTable, MishikaLLM_UserTable, Member
from mishikallm.proxy.management_endpoints.scim.scim_transformations import (
    ScimTransformations,
)
from mishikallm.types.proxy.management_endpoints.scim_v2 import SCIMGroup, SCIMUser


# Mock data
@pytest.fixture
def mock_user():
    return MishikaLLM_UserTable(
        user_id="user-123",
...
def mock_prisma_client():
    ...
    mock_db.mishikallm_teamtable.find_unique = mock_find_unique
...
class TestScimTransformations:
    ...
    @pytest.mark.asyncio
    async def test_transform_mishikallm_team_to_scim_group(
