...
from mishikallm.types.router import Deployment, MishikaLLM_Params, updateDeployment
...
class TestModelManagementAuthChecks:
    def setup_method(self):
        ...
        self.admin_user = UserAPIKeyAuth(
            user_id="test_admin", user_role=MishikallmUserRoles.PROXY_ADMIN
        )

        self.normal_user = UserAPIKeyAuth(
            user_id="test_user", user_role=MishikallmUserRoles.INTERNAL_USER
        )
    ...
    async def test_allow_team_model_action_success(self):
        ...
        model_params = Deployment(
            ...
            mishikallm_params=MishikaLLM_Params(model="test_model", team_id="test_team"),
