...
import mishikallm
from mishikallm.proxy.proxy_cli import ProxyInitializationHelpers
...
class TestProxyInitializationHelpers:
    ...
    @patch("click.echo")
    def test_echo_mishikallm_version(self, mock_echo, mock_version):
        # Setup
        ...
        # Assert
        mock_version.assert_called_once_with("mishikallm")
        mock_echo.assert_called_once_with("\nMishikaLLM: Current Version = 1.0.0\n")
    ...
    def test_get_default_unvicorn_init_args(self):
        ...
        assert args["app"] == "mishikallm.proxy.proxy_server:app"
        ...
        with patch("mishikallm.json_logs", True):
            args = ProxyInitializationHelpers._get_default_unvicorn_init_args(
                "localhost", 8000
            )
