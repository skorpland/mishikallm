...
async def test_handle_authentication_error_db_unavailable(prisma_error):
    ...
    with patch(
        "mishikallm.proxy.proxy_server.general_settings",
...
async def test_handle_authentication_error_budget_exceeded():
    ...
    with pytest.raises(ProxyException) as exc_info:
        from mishikallm.exceptions import BudgetExceededError
...
async def test_route_passed_to_post_call_failure_hook():
    ...
    with patch(
        "mishikallm.proxy.proxy_server.proxy_logging_obj.post_call_failure_hook",
