...
async def test_async_post_call_failure_hook():
    ...
    with patch(
        "mishikallm.proxy.db.db_spend_update_writer.DBSpendUpdateWriter.update_database",
        ...
        assert "mishikallm_params" in call_args["kwargs"]
        assert call_args["kwargs"]["mishikallm_params"]["proxy_server_request"] == {
            "request_id": "test_request_id"
        }
        metadata = call_args["kwargs"]["mishikallm_params"]["metadata"]
