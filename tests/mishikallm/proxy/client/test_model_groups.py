import pytest
import requests
from mishikallm.proxy.client import Client, ModelGroupsManagementClient
        ...
        "data": [
            {
                ...
                "mishikallm_params": {"timeout": 30, "max_retries": 3},
            },
            {
                "model_group_name": "azure-group",
                "models": ["azure-gpt-4", "azure-gpt-35"],
                "mishikallm_params": {"api_base": "https://azure-endpoint.com", "api_version": "2023-05-15"},
            },
        ]
    }
