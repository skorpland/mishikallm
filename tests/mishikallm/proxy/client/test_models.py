import pytest
import requests
from mishikallm.proxy.client import Client, ModelsManagementClient
from mishikallm.proxy.client.exceptions import UnauthorizedError, NotFoundError
...
def test_list_with_mock_response(client, requests_mock):
    ...
    mock_data = {"data": [{"id": "gpt-4", "type": "model"}, {"id": "gpt-3.5-turbo", "type": "model"}]}
...
def test_list_unauthorized_error(client, requests_mock):
    ...
    requests_mock.get("http://localhost:8000/models", status_code=401, json={"error": "Invalid API key"})
...
def test_list_other_errors(client, requests_mock):
    ...
    requests_mock.get("http://localhost:8000/models", status_code=500, json={"error": "Internal Server Error"})
...
def test_new_request_creation(client, base_url, api_key):
    ...
    request = client.new(model_name=model_name, model_params=model_params, model_info=model_info, return_request=True)
    ...
    # Check request body
    assert request.json == {"model_name": model_name, "mishikallm_params": model_params, "model_info": model_info}
...
def test_new_without_model_info(client):
    ...
    assert request.json == {"model_name": model_name, "mishikallm_params": model_params}
...
def test_new_unauthorized_error(client, requests_mock):
    ...
    # Mock a 401 response
    requests_mock.post(f"{client._base_url}/model/new", status_code=401, json={"error": "Unauthorized"})
...
def test_delete_unauthorized_error(client, requests_mock):
    ...
    # Mock a 401 response
    requests_mock.post(f"{client._base_url}/model/delete", status_code=401, json={"error": "Unauthorized"})
...
def test_delete_404_error(client, requests_mock):
    ...
    # Mock a 404 response
    requests_mock.post(f"{client._base_url}/model/delete", status_code=404, json={"error": "Model not found"})
...
def test_delete_other_errors(client, requests_mock):
    ...
    # Mock a 500 response
    requests_mock.post(f"{client._base_url}/model/delete", status_code=500, json={"error": "Internal Server Error"})
        ...
        "data": [
            {
                ...
                "mishikallm_params": {"model": "openai/gpt-4", "api_base": "https://api.openai.com/v1"},
            },
            {
                "model_name": "gpt-3.5-turbo",
                "model_info": {"id": "model-456", "description": "GPT-3.5 Turbo model"},
                "mishikallm_params": {"model": "openai/gpt-3.5-turbo"},
            },
        ]
    }
...
def test_info_unauthorized(client, requests_mock):
    ...
    requests_mock.get(f"{client._base_url}/v1/model/info", status_code=401, json={"error": "Unauthorized"})
...
def test_info_server_error(client, requests_mock):
    ...
    requests_mock.get(f"{client._base_url}/v1/model/info", status_code=500, json={"error": "Internal Server Error"})
...
def test_get_success_by_name(client, requests_mock):
    ...
    mock_models = {
        "data": [
            {"model_name": model_name, "model_info": {"id": "model-123"}, "mishikallm_params": {"model": "openai/gpt-4"}}
        ]
    }
...
def test_update_request_creation(client, base_url, api_key):
    ...
    request = client.update(model_id=model_id, model_params=model_params, model_info=model_info, return_request=True)
    ...
    # Check request body
    assert request.json == {"id": model_id, "mishikallm_params": model_params, "model_info": model_info}
...
def test_update_without_model_info(client):
    ...
    # Check request body doesn't include model_info
    assert request.json == {"id": model_id, "mishikallm_params": model_params}
...
def test_update_mock_response(client, requests_mock):
    ...
    model_id = "model-123"
    model_params = {"model": "openai/gpt-4"}
    mock_response = {"id": model_id, "status": "success", "message": "Model updated successfully"}
...
def test_update_unauthorized_error(client, requests_mock):
    ...
    # Mock a 401 response
    requests_mock.post(f"{client._base_url}/model/update", status_code=401, json={"error": "Unauthorized"})
...
def test_update_404_error(client, requests_mock):
    ...
    # Mock a 404 response
    requests_mock.post(f"{client._base_url}/model/update", status_code=404, json={"error": "Model not found"})
...
def test_update_other_errors(client, requests_mock):
    ...
    # Mock a 500 response
    requests_mock.post(f"{client._base_url}/model/update", status_code=500, json={"error": "Internal Server Error"})
