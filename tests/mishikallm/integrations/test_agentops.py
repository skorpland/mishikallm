...
from mishikallm.integrations.agentops.agentops import AgentOps, AgentOpsConfig
...
@patch('mishikallm.integrations.agentops.agentops.AgentOps._fetch_auth_token')
