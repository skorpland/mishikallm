...
from mishikallm.integrations._types.open_inference import (
    SpanAttributes,
    MessageAttributes,
    ToolCallAttributes,
)
from mishikallm.types.utils import Choices, StandardCallbackDynamicParams
...
def test_arize_set_attributes():
    ...
    kwargs = {
        ...
        "mishikallm_params": {"custom_llm_provider": "openai"},
    }
...
async def test_arize_dynamic_params():
    ...
    mishikallm.callbacks = [test_arize_logger]
