...
from mishikallm.proxy._types import CallInfo, Mishikallm_EntityType
...
class TestSlackAlerting(unittest.TestCase):
    ...
    def test_get_percent_of_max_budget_left(self):
        ...
        user_info = CallInfo(
            max_budget=None, spend=50.0, event_group=Mishikallm_EntityType.KEY
        )
        ...
        user_info = CallInfo(
            max_budget=0.0, spend=50.0, event_group=Mishikallm_EntityType.KEY
        )
        result = self.slack_alerting._get_percent_of_max_budget_left(user_info)
        self.assertEqual(result, 0.0)
        ...
        user_info = CallInfo(
            max_budget=100.0, spend=75.0, event_group=Mishikallm_EntityType.KEY
        )
        result = self.slack_alerting._get_percent_of_max_budget_left(user_info)
        ...
        user_info = CallInfo(
            max_budget=100.0, spend=100.0, event_group=Mishikallm_EntityType.KEY
        )
        result = self.slack_alerting._get_percent_of_max_budget_left(user_info)
        self.assertEqual(result, 0.0)
        ...
        user_info = CallInfo(
            max_budget=100.0, spend=120.0, event_group=Mishikallm_EntityType.KEY
        )
        result = self.slack_alerting._get_percent_of_max_budget_left(user_info)
