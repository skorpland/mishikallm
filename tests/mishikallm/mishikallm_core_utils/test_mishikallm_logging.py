...
def test_use_custom_pricing_for_model():
    from mishikallm.mishikallm_core_utils.mishikallm_logging import use_custom_pricing_for_model

    mishikallm_params = {
        "custom_llm_provider": "azure",
        "input_cost_per_pixel": 10,
    }
    assert use_custom_pricing_for_model(mishikallm_params) == True
