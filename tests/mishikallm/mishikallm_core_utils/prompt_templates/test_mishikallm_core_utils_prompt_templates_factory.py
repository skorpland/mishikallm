...
import mishikallm
from mishikallm.mishikallm_core_utils.prompt_templates.factory import ollama_pt, BAD_MESSAGE_ERROR_STR
...
#     with pytest.raises(mishikallm.BadRequestError) as excinfo:
