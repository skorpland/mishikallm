...
async def test_get_supports_system_message():
    ...
    from mishikallm.llms.vertex_ai.common_utils import get_supports_system_message
...
def test_build_vertex_schema():
    ...
    from mishikallm.llms.vertex_ai.common_utils import _build_vertex_schema
...
def test_process_items_with_excessive_nesting():
    ...
    # generate a schema with excessive nesting
    from mishikallm.llms.vertex_ai.common_utils import process_items
