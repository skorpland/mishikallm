...
from mishikallm.types.llms.vertex_ai import UsageMetadata
from mishikallm.types.utils import ChoiceLogprobs, Usage
...
def test_vertex_ai_thinking_output_part():
    ...
    from mishikallm.types.llms.vertex_ai import HttpxPartType
