...
from mishikallm.responses.utils import ResponseAPILoggingUtils, ResponsesAPIRequestUtils
from mishikallm.types.llms.openai import ResponsesAPIOptionalRequestParams
...
class TestResponsesAPIRequestUtils:
    ...
    def test_get_optional_params_responses_api_unsupported_param(self):
        ...
        # Execute and Assert
        with pytest.raises(mishikallm.UnsupportedParamsError) as excinfo:
    ...
    def test_decode_previous_response_id_to_original_previous_response_id(self):
        """Test decoding a MishikaLLM encoded previous_response_id to the original previous_response_id"""
        # Setup
