...
from mishikallm.proxy._types import MishikaLLM_UserTable, MishikallmUserRoles, UserAPIKeyAuth
...
import mishikallm.proxy.auth.route_checks
...
mishikallm.proxy.auth.route_checks.hash_token = mock_hash_token
