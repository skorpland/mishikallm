...
async def test_send_llm_exception_alert_success():
    ...
    """
    # Create a mock MishikallmRouter instance
    ...
    # Call the function
    from mishikallm.router_utils.handle_error import send_llm_exception_alert
...
async def test_send_llm_exception_alert_no_logger():
    ...
    """
    # Create a mock MishikallmRouter instance without a slack_alerting_logger
    mock_router = MagicMock()
...
async def test_send_llm_exception_alert_when_proxy_server_request_in_kwargs():
    ...
    """
    # Create a mock MishikallmRouter instance with a slack_alerting_logger
    mock_router = MagicMock()
    mock_router.slack_alerting_logger = AsyncMock()
