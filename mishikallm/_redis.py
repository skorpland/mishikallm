...
from mishikallm import get_secret, get_secret_str
from mishikallm.constants import REDIS_CONNECTION_POOL_TIMEOUT, REDIS_SOCKET_TIMEOUT
...
def _get_redis_client_logic(**env_overrides):
    ...
    # mishikallm.print_verbose(f"redis_kwargs: {redis_kwargs}")
    return redis_kwargs
