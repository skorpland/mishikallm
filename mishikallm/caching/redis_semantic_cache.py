"""
Redis Semantic Cache implementation for MishikaLLM
...
class RedisSemanticCache(BaseCache):
    ...
    DEFAULT_REDIS_INDEX_NAME: str = "mishikallm_semantic_cache_index"
    ...
    async def _get_async_embedding(self, prompt: str, **kwargs) -> List[float]:
        ...
        Returns:
            List[float]: The embedding vector
        """
        from mishikallm.proxy.proxy_server import llm_model_list, llm_router
