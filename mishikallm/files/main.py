...
from mishikallm.llms.azure.files.handler import AzureOpenAIFilesAPI
from mishikallm.llms.custom_httpx.llm_http_handler import BaseLLMHTTPHandler
from mishikallm.llms.openai.openai import FileDeleted, FileObject, OpenAIFilesAPI
from mishikallm.llms.vertex_ai.files.handler import VertexAIFilesHandler
...
async def acreate_file(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of POST: POST https://api.openai.com/v1/files
    """
    try:
...
def create_file(
    ...
    **kwargs,
    ...
    try:
        ...
        logging_obj = cast(
            Optional[MishikaLLMLoggingObj], kwargs.get("mishikallm_logging_obj")
        )
        ...
        if provider_config is not None:
            ...
            api_base = optional_params.api_base or mishikallm.api_base or get_secret_str("AZURE_API_BASE")  # type: ignore
            api_version = (
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'create_file'. Only ['openai', 'azure', 'vertex_ai'] are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
...
async def afile_retrieve(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of GET https://api.openai.com/v1/files
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'file_retrieve'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
...
async def afile_delete(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of DELETE https://api.openai.com/v1/files
    """
    try:
        loop = asyncio.get_event_loop()
        kwargs["is_async"] = True
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'create_batch'. Only 'openai' is supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'file_list'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'custom_llm_provider'. Supported providers are 'openai', 'azure', 'vertex_ai'.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
