...
from mishikallm.types.llms.bedrock import CohereEmbeddingRequest
...
def validate_environment(api_key, headers: dict):
    headers.update(
        {
            "Request-Source": "unspecified:mishikallm",
...
async def async_embedding(
    ...
    input: list,
    model_response: mishikallm.utils.EmbeddingResponse,
    ...
    if client is None:
        client = get_async_httpx_client(
            llm_provider=mishikallm.LlmProviders.COHERE,
