...
from mishikallm.types.utils import TextChoices
from mishikallm.utils import CustomStreamWrapper, TextCompletionResponse
...
class CodestralTextCompletion:
    ...
    def process_text_completion_response(
        ...
        for choice in _original_choices:
            ...
            _choice = mishikallm.utils.TextChoices(
    ...
    def completion(
        ...
        ## Load Config
        config = mishikallm.CodestralTextCompletionConfig.get_config()
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=mishikallm.LlmProviders.TEXT_COMPLETION_CODESTRAL,
