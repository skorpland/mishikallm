...
from mishikallm.types.llms.databricks import GenericStreamingChunk
...
class CodestralTextCompletionConfig(OpenAITextCompletionConfig):
    ...
    def _chunk_parser(self, chunk_data: str) -> GenericStreamingChunk:
        ...
        chunk_data = (
            mishikallm.CustomStreamWrapper._strip_sse_data_from_chunk(chunk_data) or ""
        )
        ...
        original_chunk = mishikallm.ModelResponse(**chunk_data_dict, stream=True)
