...
class HuggingFaceEmbeddingConfig(BaseConfig):
    ...
    hf_task: Optional[
        hf_tasks
    ] = None  # mishikallm-specific param, used to know the api spec to use when calling huggingface api
    ...
    def transform_request(
        ...
        task = mishikallm_params.get("task", None)
        ## VALIDATE API FORMAT
        ...
        ## Load Config
        config = mishikallm.HuggingFaceEmbeddingConfig.get_config()
