...
from mishikallm.types.llms.openai import AllMessageValues, ChatCompletionUsageBlock
...
class OllamaConfig(BaseConfig):
    ...
    def transform_request(
        ...
        custom_prompt_dict = (
            mishikallm_params.get("custom_prompt_dict") or mishikallm.custom_prompt_dict
        )

        text_completion_request = mishikallm_params.get("text_completion")
