...
from mishikallm.types.rerank import OptionalRerankParams, RerankBilledUnits, RerankResponse
...
class BaseRerankConfig(ABC):
    ...
    def calculate_rerank_cost(
        ...
        Input:
            ...
            - custom_llm_provider: str, the provider used for the model. If provided, used to check if the mishikallm model info is for that provider.
