...
from mishikallm.utils import get_model_info
...
class AzureOpenAIO1Config(OpenAIOSeriesConfig):
    def get_supported_openai_params(self, model: str) -> list:
        ...
        """
        all_openai_params = mishikallm.OpenAIGPTConfig().get_supported_openai_params(
            model=model
        )
    ...
    def should_fake_stream(
        ...
        ):  # o3 models support streaming - https://github.com/skorpland/mishikallm/issues/8274
            return False
