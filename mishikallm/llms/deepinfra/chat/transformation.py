...
import mishikallm
from mishikallm.constants import MIN_NON_ZERO_TEMPERATURE
                ...
                if (
                    ...
                    if mishikallm.drop_params is True or drop_params is True:
                        ...
                        raise mishikallm.utils.UnsupportedParamsError(
                            message="Deepinfra doesn't support tool_choice={}. To drop unsupported openai params from the call, set `mishikallm.drop_params = True`".format(
                                value
                            ),
                            status_code=400,
                        )
