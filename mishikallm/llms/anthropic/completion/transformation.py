...
Mishikallm provider slug: `anthropic_text/<model_name>`
"""
...
import mishikallm
from mishikallm.constants import DEFAULT_MAX_TOKENS
...
from mishikallm.llms.base_llm.chat.transformation import (
    BaseConfig,
    BaseLLMException,
...
class AnthropicTextConfig(BaseConfig):
    ...
    max_tokens_to_sample: Optional[
        int
    ] = mishikallm.max_tokens  # anthropic requires a default
    ...
    def transform_request(
        ...
        ## Load Config
        config = mishikallm.AnthropicTextConfig.get_config()
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            ...
            if param == "stop" and (isinstance(value, str) or isinstance(value, list)):
                _value = mishikallm.AnthropicConfig()._map_stop_sequences(value)
