...
from mishikallm.types.llms.anthropic_messages.anthropic_response import (
    ...
    **kwargs,
    ...
    if client is None or not isinstance(client, AsyncHTTPHandler):
        async_httpx_client = get_async_httpx_client(
            llm_provider=mishikallm.LlmProviders.ANTHROPIC
        )
    else:
    ...
    mishikallm_logging_obj.stream = stream
    mishikallm_logging_obj.model_call_details.update(request_body)
    ...
    mishikallm_logging_obj.model_call_details["httpx_response"] = response
