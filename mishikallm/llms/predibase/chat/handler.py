...
from mishikallm.types.utils import MishikaLLMLoggingBaseClass
from mishikallm.utils import Choices, CustomStreamWrapper, Message, ModelResponse, Usage
...
class PredibaseChatCompletion:
    ...
    def process_response(  # noqa: PLR0915
        ...
        stream: bool,
        logging_obj: MishikaLLMLoggingBaseClass,
        ...
        prompt_tokens = 0
        try:
            prompt_tokens = mishikallm.token_counter(messages=messages)
        except Exception:
    ...
    def completion(
        ...
        headers = mishikallm.PredibaseConfig().validate_environment(
            api_key=api_key,
            headers=headers,
            messages=messages,
        ...
        ## Load Config
        config = mishikallm.PredibaseConfig.get_config()
    ...
    async def async_completion(
        ...
        async_handler = get_async_httpx_client(
            llm_provider=mishikallm.LlmProviders.PREDIBASE,
        ...
        try:
            ...
            for exception in mishikallm.MISHIKALLM_EXCEPTION_TYPES:
