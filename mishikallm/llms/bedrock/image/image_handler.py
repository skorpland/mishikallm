...
class BedrockImageGeneration(BaseAWSLLM):
    ...
    def _prepare_request(
        ...
        Args:
            ...
            logging_obj (MishikallmLogging): The logging object to use for logging
    ...
    def _get_request_body(
        ...
        if provider == "stability":
            if mishikallm.AmazonStability3Config._is_stability_3_model(model):
                request_body = mishikallm.AmazonStability3Config.transform_request_body(
                ...
                ## LOAD CONFIG
                config = mishikallm.AmazonStabilityConfig.get_config()
            ...
            return dict(
                mishikallm.AmazonNovaCanvasConfig.transform_request_body(
