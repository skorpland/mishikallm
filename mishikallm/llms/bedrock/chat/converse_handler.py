...
class BedrockConverseLLM(BaseAWSLLM):
    ...
    async def async_streaming(
        ...
        request_data = await mishikallm.AmazonConverseConfig()._async_transform_request(
            model=model,
            messages=messages,
        ...
        prepped = self.get_request_headers(
            credentials=credentials,
            aws_region_name=mishikallm_params.get("aws_region_name") or "us-west-2",
    ...
    async def async_completion(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            ...
            client = get_async_httpx_client(
                params=_params, llm_provider=mishikallm.LlmProviders.BEDROCK
            )
        else:
        ...
        return mishikallm.AmazonConverseConfig()._transform_response(
            model=model,
            response=response,
    ...
    def completion(  # noqa: PLR0915
        ...
        _data = mishikallm.AmazonConverseConfig()._transform_request(
            model=model,
            messages=messages,
            optional_params=optional_params,
            mishikallm_params=mishikallm_params,
