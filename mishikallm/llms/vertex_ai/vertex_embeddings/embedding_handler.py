...
import mishikallm
from mishikallm.mishikallm_core_utils.mishikallm_logging import Logging as MishikaLLMLoggingObject
...
from mishikallm.llms.vertex_ai.vertex_ai_non_gemini import VertexAIError
from mishikallm.llms.vertex_ai.vertex_llm_base import VertexBase
from mishikallm.types.llms.vertex_ai import *
from mishikallm.types.utils import EmbeddingResponse
...
class VertexEmbedding(VertexBase):
    ...
    def embedding(
        ...
        vertex_request: VertexEmbeddingRequest = mishikallm.vertexAITextEmbeddingConfig.transform_openai_request_to_vertex_embedding_request(
        ...
        model_response = (
            mishikallm.vertexAITextEmbeddingConfig.transform_vertex_response_to_openai(
