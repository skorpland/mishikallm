...
from mishikallm.integrations.gcs_bucket.gcs_bucket_base import (
    GCSBucketBase,
    GCSLoggingConfig,
)
from mishikallm.llms.custom_httpx.http_handler import get_async_httpx_client
from mishikallm.types.llms.openai import CreateFileRequest, OpenAIFileObject
from mishikallm.types.llms.vertex_ai import VERTEX_CREDENTIALS_TYPES
...
class VertexAIFilesHandler(GCSBucketBase):
    ...
    def create_file(
        ...
        Only supported for Async mishikallm.acreate_file
        """
