...
import mishikallm
from mishikallm.constants import REPLICATE_POLLING_DELAY_SECONDS
...
from mishikallm.utils import CustomStreamWrapper, ModelResponse
...
def completion(
    ...
    if "stream" in optional_params and optional_params["stream"] is True:
        ...
        for retry in range(mishikallm.DEFAULT_REPLICATE_POLLING_RETRIES):
            time.sleep(
                mishikallm.DEFAULT_REPLICATE_POLLING_DELAY_SECONDS + 2 * retry
            ...
            if (
                ...
                continue
            return mishikallm.ReplicateConfig().transform_response(
                model=model,
...
async def async_completion(
    ...
    async_handler = get_async_httpx_client(
        llm_provider=mishikallm.LlmProviders.REPLICATE,
        params={"timeout": 600.0},
    )
