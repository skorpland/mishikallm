...
from mishikallm.types.utils import StreamingChatCompletionChunk
        ...
        for chunk in iterator:
            ...
            for event in event_stream_buffer:
                ...
                if message:
                    ...
                    message = (
                        mishikallm.CustomStreamWrapper._strip_sse_data_from_chunk(message)
                        or ""
                    )
            ...
            for event in event_stream_buffer:
                try:
                    ...
                    if message:
                        ...
                        # remove data: prefix and "\n\n" at the end
                        message = (
                            mishikallm.CustomStreamWrapper._strip_sse_data_from_chunk(
                                message
                            )
                            or ""
                        )
