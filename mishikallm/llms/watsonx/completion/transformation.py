...
from mishikallm.types.llms.watsonx import WatsonXAIEndpoint
from mishikallm.types.utils import GenericStreamingChunk, ModelResponse, Usage
from mishikallm.utils import map_finish_reason
...
class IBMWatsonXAIConfig(IBMWatsonXMixin, BaseConfig):
    ...
    max_new_tokens: Optional[int] = None  # mishikallm.max_tokens
