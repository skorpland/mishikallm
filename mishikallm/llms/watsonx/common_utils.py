...
from mishikallm.mishikallm_core_utils.prompt_templates import factory as ptf
...
from mishikallm.types.llms.watsonx import WatsonXAPIParams, WatsonXCredentials
...
class IBMWatsonXMixin:
    ...
    def _add_api_version_to_url(self, url: str, api_version: Optional[str]) -> str:
        api_version = api_version or mishikallm.WATSONX_DEFAULT_API_VERSION
