...
MishikaLLM supports the re rank API format, no paramter transformation occurs
"""
...
from mishikallm.llms.together_ai.rerank.transformation import TogetherAIRerankConfig
from mishikallm.types.rerank import RerankRequest, RerankResponse
...
class TogetherAIRerank(BaseLLM):
    ...
    async def async_rerank(  # New async method
        ...
        client = get_async_httpx_client(
            llm_provider=mishikallm.LlmProviders.TOGETHER_AI
        )  # Use async client
