...
from mishikallm.types.utils import Choices, Message, ModelResponse, TextCompletionResponse
    ...
    def convert_to_chat_model_response_object(
        ...
        try:
            ...
            model_response_object._hidden_params[
                "original_response"
            ] = response_object  # track original response, if users make a mishikallm.text_completion() request, we can return the original response
