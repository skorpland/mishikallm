...
from mishikallm.mishikallm_core_utils.prompt_templates.common_utils import get_tool_call_names
        ...
        for message in messages:
            ...
            if message_content and isinstance(message_content, list):
                for content_item in message_content:
                    mishikallm_specific_params = {"format"}
                        ...
                        if isinstance(content_item["image_url"], str):
                            ...
                            new_image_url_obj = ChatCompletionImageUrlObject(
                                **{  # type: ignore
                                    ...
                                    if k not in mishikallm_specific_params
                                }
                            )
