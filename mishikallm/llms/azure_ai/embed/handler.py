...
from mishikallm.llms.openai.openai import OpenAIChatCompletion
from mishikallm.types.llms.azure_ai import ImageEmbeddingRequest
    ...
    async def async_image_embedding(
        ...
        if client is None or not isinstance(client, AsyncHTTPHandler):
            client = get_async_httpx_client(
                llm_provider=mishikallm.LlmProviders.AZURE_AI,
