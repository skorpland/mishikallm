...
from mishikallm.llms.base_llm.chat.transformation import MishikaLLMLoggingObj
from mishikallm.llms.openai.common_utils import drop_params_from_unprocessable_entity_error
from mishikallm.llms.openai.openai import OpenAIConfig
from mishikallm.secret_managers.main import get_secret_str
from mishikallm.types.llms.openai import AllMessageValues
from mishikallm.types.utils import ModelResponse, ProviderField
from mishikallm.utils import _add_path_to_api_base, supports_tool_choice
...
class AzureAIStudioConfig(OpenAIConfig):
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            "https://mishikallm8397336933.services.ai.azure.com"
            OR
            "https://mishikallm8397336933.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview"
        - model: Model name.
    ...
    def transform_request(
        ...
        return super().transform_request(
            model, messages, optional_params, mishikallm_params, headers
        )
    ...
    def should_retry_llm_api_inside_llm_translation_on_http_error(
        self, e: httpx.HTTPStatusError, mishikallm_params: dict
    ) -> bool:
        should_drop_params = mishikallm_params.get("drop_params") or mishikallm.drop_params
    ...
    def transform_request_on_unprocessable_entity_error(
        ...
        if (
            ...
            mishikallm.remove_index_from_tool_calls(
                messages=_messages,
            )
        elif (
            AzureFoundryErrorStrings.SET_EXTRA_PARAMETERS_TO_PASS_THROUGH.value
