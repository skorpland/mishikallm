...
from mishikallm.types.utils import GenericStreamingChunk
from mishikallm.utils import ImageResponse, ModelResponse
...
class CustomLLM(BaseLLM):
    ...
    async def aimage_generation(
        ...
        api_key: Optional[
            str
        ],  # dynamically set api_key - https://docs.21t.cc/docs/set_keys#api_key
        api_base: Optional[
            str
        ],  # dynamically set api_base - https://docs.21t.cc/docs/set_keys#api_base
        optional_params: dict,
        logging_obj: Any,
        timeout: Optional[Union[float, httpx.Timeout]] = None,
        client: Optional[AsyncHTTPHandler] = None,
