...
from mishikallm._service_logger import ServiceTypes
    ...
    async def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if "PROXY" not in func.__name__:
                ...
                # in mishikallm custom callbacks kwargs is passed as arg[0]
                # https://docs.21t.cc/docs/observability/custom_callback#callback-functions
                args is not None
                and len(args) > 1
                ...
                if parent_otel_span is not None:
                    metadata = get_mishikallm_metadata_from_kwargs(kwargs=passed_kwargs)
