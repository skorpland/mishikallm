...
from mishikallm.proxy.db.db_transaction_queue.base_update_queue import (
    BaseUpdateQueue,
    service_logger_obj,
)
...
class SpendUpdateQueue(BaseUpdateQueue):
    ...
    def get_aggregated_db_spend_update_transactions(
        ...
        entity_type_to_dict_key = {
            Mishikallm_EntityType.USER: "user_list_transactions",
            Mishikallm_EntityType.END_USER: "end_user_list_transactions",
            Mishikallm_EntityType.KEY: "key_list_transactions",
            Mishikallm_EntityType.TEAM: "team_list_transactions",
            Mishikallm_EntityType.TEAM_MEMBER: "team_member_list_transactions",
            Mishikallm_EntityType.ORGANIZATION: "org_list_transactions",
        }
