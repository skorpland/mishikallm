...
from mishikallm.proxy._types import ProxyErrorTypes, ProxyException, UserAPIKeyAuth
from mishikallm.proxy.auth.auth_utils import _get_request_ip_address
...
class UserAPIKeyAuthExceptionHandler:
    ...
    async def _handle_authentication_error(
        ...
        """
        Handles Connection Errors when reading a Virtual Key from MishikaLLM DB
        ...
        if (
            ...
            verbose_proxy_logger.exception(
                "mishikallm.proxy.proxy_server.user_api_key_auth(): Exception occured - {}\nRequester IP Address:{}".format(
                    str(e),
                    requester_ip,
                ),
