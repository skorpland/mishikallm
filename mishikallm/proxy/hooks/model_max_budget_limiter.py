...
from mishikallm.integrations.custom_logger import Span
...
class _PROXY_VirtualKeyModelMaxBudgetLimiter(RouterBudgetLimiting):
        ...
        if (
            ...
            if (
                ...
                raise mishikallm.BudgetExceededError(
                    message=f"MishikaLLM Virtual Key: {user_api_key_dict.token}, key_alias: {user_api_key_dict.key_alias}, exceeded budget for model={model}",
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        _mishikallm_params: dict = kwargs.get("mishikallm_params", {}) or {}
        _metadata: dict = _mishikallm_params.get("metadata", {}) or {}
