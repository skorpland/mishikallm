...
"""
1. Create pass-through endpoints for any MISHIKALLM_BASE_URL/langfuse/<endpoint> map to LANGFUSE_BASE_URL/<endpoint>
"""
...
from mishikallm.proxy.mishikallm_pre_call_utils import _get_dynamic_logging_metadata
...
async def langfuse_proxy_route(
    ...
    """
    Call Langfuse via MishikaLLM proxy. Works with Langfuse SDK.

    [Docs](https://docs.21t.cc/docs/pass_through/langfuse)
    """
    ...
    langfuse_public_key = dynamic_langfuse_public_key or mishikallm.utils.get_secret(
        secret_name="LANGFUSE_PUBLIC_KEY"
    )
    langfuse_secret_key = dynamic_langfuse_secret_key or mishikallm.utils.get_secret(
