...
from mishikallm.proxy.utils import jsonify_object
...
async def update_budget(
    ...
    response = await prisma_client.db.mishikallm_budgettable.update(
...
async def info_budget(data: BudgetRequest):
    ...
    response = await prisma_client.db.mishikallm_budgettable.find_many(
...
async def budget_settings(
    ...
    db_budget_row = await prisma_client.db.mishikallm_budgettable.find_first(
...
async def delete_budget(
    ...
    response = await prisma_client.db.mishikallm_budgettable.delete(
