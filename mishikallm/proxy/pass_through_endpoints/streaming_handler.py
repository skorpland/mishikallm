...
from mishikallm.proxy._types import PassThroughEndpointLoggingResultValues
from mishikallm.types.passthrough_endpoints.pass_through_endpoints import EndpointType
from mishikallm.types.utils import StandardPassThroughResponseObject
...
class PassThroughStreamingHandler:
    ...
    async def _route_streaming_logging_to_handler(
        ...
        threading.Thread(
            target=mishikallm_logging_obj.success_handler,
            args=(
                standard_logging_response_object,
                start_time,
                end_time,
        ...
        await mishikallm_logging_obj.async_success_handler(
