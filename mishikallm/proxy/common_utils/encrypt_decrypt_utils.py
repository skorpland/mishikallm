...
def _get_salt_key():
    ...
    salt_key = os.getenv("MISHIKALLM_SALT_KEY", None)

    if salt_key is None:
        verbose_proxy_logger.debug(
            "MISHIKALLM_SALT_KEY is None using master_key to encrypt/decrypt secrets stored in DB"
        )
