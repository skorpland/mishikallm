...
Example: `spend_logs_row_count` is used to store the number of rows in the `MishikaLLM_SpendLogs` table.
"""

from typing import Any, Literal

from mishikallm.proxy._types import ProxyStateVariables
