"""
Functions to create audit logs for MishikaLLM Proxy
"""
...
async def create_audit_log_for_update(request_data: MishikaLLM_AuditLogs):
    """
    ...
    if mishikallm.store_audit_logs is not True:
        return
    ...
    try:
        await prisma_client.db.mishikallm_auditlog.create(
            data={
