"""HTTP client for making requests to the MishikaLLM proxy server."""
...
class HTTPClient:
    ...
    def __init__(self, base_url: str, api_key: Optional[str] = None, timeout: int = 30):
        ...
        Args:
            base_url: Base URL of the MishikaLLM proxy server
    ...
    def request(
        ...
        **kwargs: Any,
        ...
        """Make an HTTP request to the MishikaLLM proxy server.

        This method is used to make generic requests to the MishikaLLM proxy
        ...
        Example:
            >>> client.http.request("POST", "/health/test_connection", json={
                "mishikallm_params": {
                    ...
                    "mishikallm_credential_name": None,
                    "api_key": "6xxxxxxx",
