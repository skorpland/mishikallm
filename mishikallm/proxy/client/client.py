...
class Client:
    """Main client for interacting with the MishikaLLM proxy API."""
    ...
    def __init__(
        ...
        """
        Initialize the MishikaLLM proxy client.

        Args:
            base_url (str): The base URL of the MishikaLLM proxy server (e.g., "http://localhost:4000")
