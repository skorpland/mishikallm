...
from mishikallm.batches.main import (
    CancelBatchRequest,
    CreateBatchRequest,
...
from mishikallm.proxy.openai_files_endpoints.files_endpoints import is_known_model
...
async def create_batch(
    ...
    try:
        ...
        if (
            ...
            response = await mishikallm.acreate_batch(
        ...
        verbose_proxy_logger.exception(
            "mishikallm.proxy.proxy_server.create_batch(): Exception occured - {}".format(
                str(e)
            )
        )
...
async def retrieve_batch(
    ...
    try:
        ...
        # setup logging
        data["mishikallm_call_id"] = request.headers.get(
        ...
        if mishikallm.enable_loadbalancing_on_batch_endpoints is True:
            ...
            response = await mishikallm.aretrieve_batch(
        ...
        verbose_proxy_logger.exception(
            "mishikallm.proxy.proxy_server.retrieve_batch(): Exception occured - {}".format(
                str(e)
            )
        )
        raise handle_exception_on_proxy(e)
...
async def list_batches(
    ...
    ```
    """
    from mishikallm.proxy.proxy_server import proxy_logging_obj, version
    ...
    try:
        ...
        response = await mishikallm.alist_batches(
...
async def cancel_batch(
    ...
    try:
        ...
        response = await mishikallm.acancel_batch(
            custom_llm_provider=custom_llm_provider,  # type: ignore
            **_cancel_batch_data
        )
