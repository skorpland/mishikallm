...
from mishikallm.mishikallm_core_utils.mishikallm_logging import _get_masked_values
...
from mishikallm.proxy.utils import handle_exception_on_proxy, jsonify_object
from mishikallm.types.utils import CreateCredentialItem, CredentialItem
...
async def create_credential(
    ...
    try:
        ...
        await prisma_client.db.mishikallm_credentialstable.create(
            data={
...
async def delete_credential(
    ...
    try:
        ...
        await prisma_client.db.mishikallm_credentialstable.delete(
            where={"credential_name": credential_name}
        )

        ## DELETE FROM MISHIKALLM ##
        mishikallm.credential_list = [
            cred
            for cred in mishikallm.credential_list
...
async def update_credential(
    ...
    try:
        ...
        db_credential = await prisma_client.db.mishikallm_credentialstable.find_unique(
            where={"credential_name": credential_name},
        )
        ...
        await prisma_client.db.mishikallm_credentialstable.update(
            where={"credential_name": credential_name},
            data={
