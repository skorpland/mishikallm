...
# |   https://github.com/skorpland/mishikallm/issues/  |
# +-----------------------------------------------+
#
...
class _OPTIONAL_PresidioPIIMasking(CustomGuardrail):
    ...
    def validate_environment(
        ...
        self.presidio_anonymizer_api_base: Optional[
            str
        ] = presidio_anonymizer_api_base or mishikallm.get_secret(
    ...
    async def async_post_call_success_hook(  # type: ignore
        ...
        if self.output_parse_pii is False and mishikallm.output_parse_pii is False:
            return response
