...
from mishikallm.llms.azure.fine_tuning.handler import AzureOpenAIFineTuningAPI
from mishikallm.llms.openai.fine_tuning.handler import OpenAIFineTuningAPI
from mishikallm.llms.vertex_ai.fine_tuning.handler import VertexFineTuningAPI
...
from mishikallm.utils import client, supports_httpx_timeout
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            response = openai_fine_tuning_apis_instance.create_fine_tuning_job(
                ...
                client=kwargs.get(
                    "client", None
                ),  # note, when we add this to `GenericMishikaLLMParams` it impacts a lot of other tests + linting
            )
        # Azure OpenAI
    ...
    **kwargs,
    ...
    try:
        ...
        # Azure OpenAI
            ...
            api_base = optional_params.api_base or mishikallm.api_base or get_secret("AZURE_API_BASE")  # type: ignore
    ...
    **kwargs,
    ...
    try:
        ...
        # Azure OpenAI
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'retrieve_fine_tuning_job'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
