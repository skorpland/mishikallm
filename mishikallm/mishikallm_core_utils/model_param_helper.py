...
from mishikallm.types.rerank import RerankRequest
...
class ModelParamHelper:
    ...
    def _get_all_llm_api_params() -> Set[str]:
        ...
        chat_completion_kwargs = (
            ModelParamHelper._get_mishikallm_supported_chat_completion_kwargs()
        )
        text_completion_kwargs = (
            ModelParamHelper._get_mishikallm_supported_text_completion_kwargs()
        )
        embedding_kwargs = ModelParamHelper._get_mishikallm_supported_embedding_kwargs()
        transcription_kwargs = (
            ModelParamHelper._get_mishikallm_supported_transcription_kwargs()
        )
        rerank_kwargs = ModelParamHelper._get_mishikallm_supported_rerank_kwargs()
    ...
    @staticmethod
    def get_mishikallm_provider_specific_params_for_chat_params() -> Set[str]:
        return set(["thinking"])

    @staticmethod
    def _get_mishikallm_supported_chat_completion_kwargs() -> Set[str]:
        """
        Get the mishikallm supported chat completion kwargs
        ...
        mishikallm_provider_specific_params: Set[str] = (
            ModelParamHelper.get_mishikallm_provider_specific_params_for_chat_params()
        )
        all_chat_completion_kwargs: Set[str] = non_streaming_params.union(
            streaming_params
        ).union(mishikallm_provider_specific_params)
        return all_chat_completion_kwargs

    @staticmethod
    def _get_mishikallm_supported_text_completion_kwargs() -> Set[str]:
        """
        Get the mishikallm supported text completion kwargs
    ...
    @staticmethod
    def _get_mishikallm_supported_rerank_kwargs() -> Set[str]:
        """
        Get the mishikallm supported rerank kwargs
        """
        return set(RerankRequest.model_fields.keys())

    @staticmethod
    def _get_mishikallm_supported_embedding_kwargs() -> Set[str]:
        """
        Get the mishikallm supported embedding kwargs
    ...
    @staticmethod
    def _get_mishikallm_supported_transcription_kwargs() -> Set[str]:
        """
        Get the mishikallm supported transcription kwargs
