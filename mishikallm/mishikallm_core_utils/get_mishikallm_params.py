...
def _get_base_model_from_mishikallm_call_metadata(
...
def get_mishikallm_params(
    ...
    mishikallm_metadata: Optional[dict] = None,
    ...
    **kwargs,
    ...
    mishikallm_params = {
        ...
        "stream_response": {},  # mishikallm_call_id: ModelResponse Dict
        ...
        or _get_base_model_from_mishikallm_call_metadata(metadata=metadata),
