...
from mishikallm.llms.azure.batches.handler import AzureBatchesAPI
from mishikallm.llms.openai.openai import OpenAIBatchesAPI
from mishikallm.llms.vertex_ai.batches.handler import VertexAIBatchPrediction
...
from mishikallm.utils import client, get_mishikallm_params, supports_httpx_timeout
...
async def acreate_batch(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of POST: https://api.openai.com/v1/batches
    """
    try:
...
def create_batch(
    ...
    **kwargs,
    ...
    try:
        ...
        mishikallm_logging_obj: MishikaLLMLoggingObj = kwargs.get("mishikallm_logging_obj", None)
        ### TIMEOUT LOGIC ###
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support custom_llm_provider={} for 'create_batch'".format(
                    custom_llm_provider
                ),
                model="n/a",
...
async def aretrieve_batch(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of GET https://api.openai.com/v1/batches/{batch_id}
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'list_batch'. Only 'openai' is supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
...
async def acancel_batch(
    ...
    **kwargs,
    ...
    MishikaLLM Equivalent of POST https://api.openai.com/v1/batches/{batch_id}/cancel
    """
    try:
        loop = asyncio.get_event_loop()
    ...
    **kwargs,
    ...
    try:
        ...
        if custom_llm_provider == "openai":
            ...
            raise mishikallm.exceptions.BadRequestError(
                message="MishikaLLM doesn't support {} for 'cancel_batch'. Only 'openai' and 'azure' are supported.".format(
                    custom_llm_provider
                ),
                model="n/a",
                llm_provider=custom_llm_provider,
