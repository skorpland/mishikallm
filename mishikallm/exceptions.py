...
## MishikaLLM versions of the OpenAI Exception Types
...
class AuthenticationError(openai.AuthenticationError):  # type: ignore
    def __init__(
        ...
        mishikallm_debug_info: Optional[str] = None,
        max_retries: Optional[int] = None,
        num_retries: Optional[int] = None,
    ):
        self.status_code = 401
        self.message = "mishikallm.AuthenticationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
    ...
    def __str__(self):
        ...
        if self.num_retries:
            _message += f" MishikaLLM Retried: {self.num_retries} times"
        if self.max_retries:
            _message += f", MishikaLLM Max Retries: {self.max_retries}"
        return _message
...
class NotFoundError(openai.NotFoundError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.NotFoundError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class BadRequestError(openai.BadRequestError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.BadRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
...
class UnprocessableEntityError(openai.UnprocessableEntityError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.UnprocessableEntityError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class Timeout(openai.APITimeoutError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.Timeout: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class PermissionDeniedError(openai.PermissionDeniedError):  # type:ignore
    def __init__(
        ...
        self.message = "mishikallm.PermissionDeniedError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class RateLimitError(openai.RateLimitError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.RateLimitError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class ContextWindowExceededError(BadRequestError):  # type: ignore
    def __init__(
        ...
        super().__init__(
            ...
            mishikallm_debug_info=self.mishikallm_debug_info,
        )  # Call the base class constructor with the parameters it needs

        # set after, to make it clear the raised error is a context window exceeded error
        self.message = "mishikallm.ContextWindowExceededError: {}".format(self.message)
...
class RejectedRequestError(BadRequestError):  # type: ignore
    def __init__(
        ...
        self.status_code = 400
        self.message = "mishikallm.RejectedRequestError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
...
class ContentPolicyViolationError(BadRequestError):  # type: ignore
    ...
    def __init__(
        ...
        self.status_code = 400
        self.message = "mishikallm.ContentPolicyViolationError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class ServiceUnavailableError(openai.APIStatusError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.ServiceUnavailableError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class InternalServerError(openai.InternalServerError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.InternalServerError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class APIError(openai.APIError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.APIError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class APIConnectionError(openai.APIConnectionError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.APIConnectionError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.status_code = 500
        self.mishikallm_debug_info = mishikallm_debug_info
...
class APIResponseValidationError(openai.APIResponseValidationError):  # type: ignore
    def __init__(
        ...
        self.message = "mishikallm.APIResponseValidationError: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        request = httpx.Request(method="POST", url="https://api.openai.com/v1")
...
class JSONSchemaValidationError(APIResponseValidationError):
    def __init__(
        ...
        self.schema = schema
        self.model = model
        message = "mishikallm.JSONSchemaValidationError: model={}, returned an invalid response={}, for schema={}.\nAccess raw response with `e.raw_response`".format(
...
class UnsupportedParamsError(BadRequestError):
    def __init__(
        ...
        self.status_code = 400
        self.message = "mishikallm.UnsupportedParamsError: {}".format(message)
        self.model = model
        self.llm_provider = llm_provider
        self.mishikallm_debug_info = mishikallm_debug_info
...
class MockException(openai.APIError):
    ...
    def __init__(
        ...
        self.status_code = status_code
        self.message = "mishikallm.MockException: {}".format(message)
        self.llm_provider = llm_provider
        self.model = model
        self.mishikallm_debug_info = mishikallm_debug_info
        self.max_retries = max_retries
...
class MishikaLLMUnknownProvider(BadRequestError):
    def __init__(self, model: str, custom_llm_provider: Optional[str] = None):
        self.message = MishikaLLMCommonStrings.llm_provider_not_provided.value.format(
