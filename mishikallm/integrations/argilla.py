...
from mishikallm.types.integrations.argilla import (
...
class ArgillaLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        if mishikallm.argilla_transformation_object is None:
            raise Exception(
                "'mishikallm.argilla_transformation_object' is required, to log your payload to Argilla."
            )
        self.validate_argilla_transformation_object(
            mishikallm.argilla_transformation_object
        )
        self.argilla_transformation_object = mishikallm.argilla_transformation_object
        ...
        _batch_size = (
            os.getenv("ARGILLA_BATCH_SIZE", None) or mishikallm.argilla_batch_size
        )
        if _batch_size:
