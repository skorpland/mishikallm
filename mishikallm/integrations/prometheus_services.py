# used for monitoring mishikallm services health on `/metrics` endpoint on MishikaLLM Proxy
#### What this does ####
#    On success + failure, log events to Prometheus for mishikallm / adjacent services (mishikallm, redis, postgres, llm api providers)
...
from mishikallm.types.services import (
...
class PrometheusServicesLogger:
    ...
    mishikallm_service_latency = None  # Class-level attribute to store the Histogram
    ...
    def create_histogram(self, service: str, type_of_request: str):
        metric_name = "mishikallm_{}_{}".format(service, type_of_request)
