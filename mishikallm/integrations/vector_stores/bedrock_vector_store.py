...
from mishikallm.types.integrations.rag.bedrock_knowledgebase import (
    BedrockKBContent,
...
from mishikallm.types.llms.openai import AllMessageValues, ChatCompletionUserMessage
from mishikallm.types.utils import StandardLoggingVectorStoreRequest
from mishikallm.types.vector_stores import (
    VectorStoreResultContent,
    VectorStoreSearchResponse,
    VectorStoreSearchResult,
)
from mishikallm.utils import load_credentials_from_list
...
if TYPE_CHECKING:
    from mishikallm.mishikallm_core_utils.mishikallm_logging import StandardCallbackDynamicParams
else:
...
class BedrockVectorStore(BaseVectorStore, BaseAWSLLM):
    ...
    async def async_get_chat_completion_prompt(
        ...
        vector_store_ids = mishikallm.vector_store_registry.pop_vector_store_ids_to_run(
        ...
        if vector_store_ids:
            for vector_store_id in vector_store_ids:
                ...
                #################################################################################################
                ########## LOGGING for Standard Logging Payload, Langfuse, s3, MishikaLLM DB etc. ##################
                #################################################################################################
            ...
            mishikallm_logging_obj.model_call_details["vector_store_request_metadata"] = (
