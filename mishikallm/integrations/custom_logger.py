...
from mishikallm.types.integrations.argilla import ArgillaItem
from mishikallm.types.llms.openai import AllMessageValues, ChatCompletionRequest
...
class CustomLogger:  # https://docs.21t.cc/docs/observability/custom_callback#callback-class
    ...
    #### ADAPTERS #### Allow calling 100+ LLMs in custom format - https://github.com/skorpland/mishikallm/pulls

    def translate_completion_input_params(
        self, kwargs
    ) -> Optional[ChatCompletionRequest]:
        """
        Translates the input params, from the provider's native format to the mishikallm.completion() format.
        """
        pass
    ...
    #### SINGLE-USE #### - https://docs.21t.cc/docs/observability/custom_callback#using-your-custom-callback-function
    ...
    def _truncate_text(self, text: str, max_length: int) -> str:
        ...
        return (
            text[:max_length]
            + "...truncated by mishikallm, this logger does not support large content"
