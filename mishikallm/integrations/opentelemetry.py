...
from mishikallm.types.services import ServiceLoggerPayload
...
if TYPE_CHECKING:
    ...
    from mishikallm.proxy.proxy_server import UserAPIKeyAuth as _UserAPIKeyAuth
...
MISHIKALLM_TRACER_NAME = os.getenv("OTEL_TRACER_NAME", "mishikallm")
MISHIKALLM_RESOURCE: Dict[Any, Any] = {
    "service.name": os.getenv("OTEL_SERVICE_NAME", "mishikallm"),
    "deployment.environment": os.getenv("OTEL_ENVIRONMENT_NAME", "production"),
    "model_id": os.getenv("OTEL_SERVICE_NAME", "mishikallm"),
}
RAW_REQUEST_SPAN_NAME = "raw_gen_ai_request"
MISHIKALLM_REQUEST_SPAN_NAME = "mishikallm_request"
...
class OpenTelemetry(CustomLogger):
    def __init__(
        ...
        **kwargs,
        ...
        provider = TracerProvider(resource=Resource(attributes=MISHIKALLM_RESOURCE))
        provider.add_span_processor(self._get_span_processor())
        self.callback_name = callback_name

        trace.set_tracer_provider(provider)
        self.tracer = trace.get_tracer(MISHIKALLM_TRACER_NAME)
        ...
        self._init_otel_logger_on_mishikallm_proxy()

    def _init_otel_logger_on_mishikallm_proxy(self):
        """
        Initializes OpenTelemetry for mishikallm proxy server
        ...
        if "otel" not in mishikallm.service_callback:
            mishikallm.service_callback.append("otel")
                ...
                for key, value in event_metadata.items():
                    ...
                    if isinstance(value, dict):
                        try:
                            ...
                            value = "mishikallm logging error - could_not_json_serialize"
                    self.safe_set_attribute(
                        span=service_logging_span,
                        key=key,
                        value=value,
    ...
    def _handle_sucess(self, kwargs, response_obj, start_time, end_time):
        ...
        # Span 1: Requst sent to mishikallm SDK
    ...
    def set_tools_attributes(self, span: Span, tools):
        ...
        from mishikallm.proxy._types import SpanAttributes
    ...
    def set_attributes(  # noqa: PLR0915
        ...
        try:
            if self.callback_name == "arize_phoenix":
                from mishikallm.integrations.arize.arize_phoenix import ArizePhoenixLogger
                ...
                from mishikallm.integrations.langtrace import LangtraceAttributes
            ...
            self.safe_set_attribute(
                ...
                value=mishikallm_params.get("custom_llm_provider", "Unknown"),
            )
    ...
    def set_raw_request_attributes(self, span: Span, kwargs, response_obj):
        ...
        mishikallm_params = kwargs.get("mishikallm_params", {}) or {}
        custom_llm_provider = mishikallm_params.get("custom_llm_provider", "Unknown")
        ...
        if _raw_response and isinstance(_raw_response, str):
            ...
            try:
                ...
                verbose_logger.debug(
                    "mishikallm.integrations.opentelemetry.py::set_raw_request_attributes() - raw_response not json string - {}".format(
                        _raw_response
                    )
                )
    ...
    def _get_span_name(self, kwargs):
        return MISHIKALLM_REQUEST_SPAN_NAME
    ...
    def _get_span_context(self, kwargs):
        ...
        _metadata = mishikallm_params.get("metadata", {}) or {}
        parent_otel_span = _metadata.get("mishikallm_parent_otel_span", None)
    ...
    def create_mishikallm_proxy_request_started_span(
        self,
        start_time: datetime,
        headers: dict,
    ) -> Optional[Span]:
