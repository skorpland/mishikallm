...
class HeliconeLogger:
    ...
    def log_success(
        ...
        try:
            ...
            kwargs.get("mishikallm_call_id", None)
            ...
            if isinstance(response_obj, mishikallm.EmbeddingResponse) or isinstance(
            ...
            response = mishikallm.module_level_client.post(url, headers=headers, json=data)
