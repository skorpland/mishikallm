...
from mishikallm.types.integrations.pagerduty import (
    AlertingConfig,
...
class PagerDutyAlerting(SlackAlerting):
    ...
    def __init__(
        ...
        if premium_user is not True:
            raise ValueError(
                f"PagerDutyAlerting is only available for MishikaLLM Enterprise users. {CommonProxyErrors.not_premium_user.value}"
            )
        ...
        try:
            ...
            payload: PagerDutyRequestBody = PagerDutyRequestBody(
                payload=PagerDutyPayload(
                    ...
                    severity="critical",
                    source="MishikaLLM Alert",
                    component="MishikaLLM",
                    custom_details=custom_details,
                ),
