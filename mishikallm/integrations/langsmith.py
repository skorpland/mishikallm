...
from mishikallm.types.integrations.langsmith import *
from mishikallm.types.utils import StandardCallbackDynamicParams, StandardLoggingPayload
...
class LangsmithLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        _batch_size = (
            os.getenv("LANGSMITH_BATCH_SIZE", None) or mishikallm.langsmith_batch_size
        )
    ...
    def get_credentials_from_env(
        ...
        _credentials_project = (
            langsmith_project or os.getenv("LANGSMITH_PROJECT") or "mishikallm-completion"
        )
    ...
    def _prepare_log_data(
        ...
        try:
            ...
            metadata = _mishikallm_params.get("metadata", {}) or {}
            ...
            data = {
                "name": run_name,
                "run_type": "llm",  # this should always be llm, since mishikallm always logs llm calls. Langsmith allow us to log "chain"
                "inputs": payload,
