...
Users can define
- `cache_control_injection_points` in the completion params and mishikallm will inject the cache control directives into the messages at the specified injection points.
...
from mishikallm.types.integrations.anthropic_cache_control_hook import (
    CacheControlInjectionPoint,
    CacheControlMessageInjectionPoint,
)
from mishikallm.types.llms.openai import AllMessageValues, ChatCompletionCachedContent
