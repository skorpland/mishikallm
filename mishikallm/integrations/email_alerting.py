...
from mishikallm.proxy._types import WebhookEvent

# we use this for the email header, please send a test email if you change this. verify it looks good on email
MISHIKALLM_LOGO_URL = "https://mishikallm-listing.s3.amazonaws.com/mishikallm_logo.png"
MISHIKALLM_SUPPORT_CONTACT = "support@berri.ai"
...
async def send_team_budget_alert(webhook_event: WebhookEvent) -> bool:
    ...
    <img src="{email_logo_url}" alt="MishikaLLM Logo" width="150" height="50" /> <br/><br/><br/>
    ...
    email_event = {
        ...
        "subject": f"MishikaLLM {event_name} for Team {team_alias}",
