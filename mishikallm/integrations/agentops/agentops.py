"""
AgentOps integration for MishikaLLM - Provides OpenTelemetry tracing for LLM calls
"""
import os
from dataclasses import dataclass
from typing import Optional, Dict, Any
from mishikallm.integrations.opentelemetry import OpenTelemetry, OpenTelemetryConfig
...
class AgentOps(OpenTelemetry):
    ...
    def __init__(
        ...
        resource_attrs = {
            "service.name": config.service_name or "mishikallm",
