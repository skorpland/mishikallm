...
REDIS_UPDATE_BUFFER_KEY = "mishikallm_spend_update_buffer"
REDIS_DAILY_SPEND_UPDATE_BUFFER_KEY = "mishikallm_daily_spend_update_buffer"
REDIS_DAILY_TEAM_SPEND_UPDATE_BUFFER_KEY = "mishikallm_daily_team_spend_update_buffer"
REDIS_DAILY_TAG_SPEND_UPDATE_BUFFER_KEY = "mishikallm_daily_tag_spend_update_buffer"
...
]  # these have been tested on extensively. But by default all text2text-generation and text-generation models are supported by mishikaLLM. - https://docs.21t.cc/docs/providers
empower_models = [
...
########################### MishikaLLM Proxy Specific Constants ###########################
########################################################################################
MAX_SPENDLOG_ROWS_TO_QUERY = (
    1_000_000  # if spendLogs has more than 1M rows, do not query the DB
)
DEFAULT_SOFT_BUDGET = (
    50.0  # by default all mishikallm proxy keys have a soft budget of 50.0
)
# makes it clear this is a rate limit error for a mishikallm virtual key
RATE_LIMIT_ERROR_MESSAGE_FOR_VIRTUAL_KEY = "MishikaLLM Virtual Key user_api_key_hash"
...
UI_SESSION_TOKEN_TEAM_ID = "mishikallm-dashboard"
MISHIKALLM_PROXY_ADMIN_NAME = "default_user_id"
...
LENGTH_OF_MISHIKALLM_GENERATED_KEY = 16
