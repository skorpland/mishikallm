...
from mishikallm.llms.bedrock.rerank.handler import BedrockRerankHandler
from mishikallm.llms.custom_httpx.llm_http_handler import BaseLLMHTTPHandler
from mishikallm.llms.together_ai.rerank.handler import TogetherAIRerank
from mishikallm.rerank_api.rerank_utils import get_optional_rerank_params
...
from mishikallm.utils import ProviderConfigManager, client, exception_type
...
def rerank(  # noqa: PLR0915
    ...
    custom_llm_provider: Optional[
        Literal["cohere", "together_ai", "azure_ai", "infinity", "mishikallm_proxy"]
    ] = None,
    top_n: Optional[int] = None,
    rank_fields: Optional[List[str]] = None,
    ...
    try:
        ...
        rerank_provider_config: BaseRerankConfig = (
            ProviderConfigManager.get_provider_rerank_config(
                model=model,
                provider=mishikallm.LlmProviders(_custom_llm_provider),
                api_base=optional_params.api_base,
        ...
        optional_rerank_params: OptionalRerankParams = get_optional_rerank_params(
            ...
            model=model,
            drop_params=kwargs.get("drop_params") or mishikallm.drop_params or False,
            query=query,
            documents=documents,
        ...
        if _custom_llm_provider == "cohere" or _custom_llm_provider == "mishikallm_proxy":
            # Implement Cohere rerank logic
            api_key: Optional[str] = (
                dynamic_api_key or optional_params.api_key or mishikallm.api_key
            )
            ...
            api_key = dynamic_api_key or optional_params.api_key or mishikallm.api_key
