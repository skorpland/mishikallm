...
class PatternMatchRouter:
    ...
    doc: https://docs.21t.cc/docs/proxy/configs#provider-specific-wildcard-routing
    ...
    def _return_pattern_matched_deployments(
        ...
        for deployment in deployments:
            ...
            new_deployment["mishikallm_params"][
                "model"
            ] = PatternMatchRouter.set_deployment_model_name(
                matched_pattern=matched_pattern,
                mishikallm_deployment_mishikallm_model=deployment["mishikallm_params"]["model"],
            )
    ...
    def set_deployment_model_name(
        ...
        mishikallm_deployment_mishikallm_model: str,
    ) -> str:
        """
        ...
        if "*" not in mishikallm_deployment_mishikallm_model:
            return mishikallm_deployment_mishikallm_model

        wildcard_count = mishikallm_deployment_mishikallm_model.count("*")
        ...
        # Replace the corresponding wildcards in the mishikallm model pattern with extracted segments
        for segment in dynamic_segments:
            mishikallm_deployment_mishikallm_model = mishikallm_deployment_mishikallm_model.replace(
                "*", segment, 1
            )
