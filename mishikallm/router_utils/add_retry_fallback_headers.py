...
from mishikallm.types.utils import HiddenParams
...
def add_retry_headers_to_response(
    ...
    """
    retry_headers = {
        "x-mishikallm-attempted-retries": attempted_retries,
    }
    if max_retries is not None:
        retry_headers["x-mishikallm-max-retries"] = max_retries
...
def add_fallback_headers_to_response(
    ...
    """
    fallback_headers = {
        "x-mishikallm-attempted-fallbacks": attempted_fallbacks,
    }
