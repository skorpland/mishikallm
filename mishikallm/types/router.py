"""
mishikallm.Router Types - includes RouterConfig, UpdateRouterConfig, ModelInfo etc
"""
...
class ModelConfig(BaseModel):
    model_name: str
    mishikallm_params: Union[CompletionRequest, EmbeddingRequest]
    tpm: int
    rpm: int
...
class RouterConfig(BaseModel):
    ...
    default_mishikallm_params: Optional[Dict[str, str]] = {}
...
class CredentialMishikaLLMParams(BaseModel):
...
class CustomPricingMishikaLLMParams(BaseModel):
    ## CUSTOM PRICING ##
...
class GenericMishikaLLMParams(CredentialMishikaLLMParams, CustomPricingMishikaLLMParams):
    """
    MishikaLLM Params without 'model' arg (used across completion / assistants api)
    """
    ...
    mishikallm_credential_name: Optional[str] = None
    ...
    def __init__(
        ...
        **params,
        ...
        # We need to keep max_retries in args since it's a parameter of GenericMishikaLLMParams
        args[
            "max_retries"
...
class MishikaLLM_Params(GenericMishikaLLMParams):
    """
    MishikaLLM Params with 'model' requirement - used for completions
    """
    ...
    def __init__(
        ...
        # set a max-size of file that can be passed to mishikallm proxy
        max_file_size_mb: Optional[float] = None,
...
class updateMishikaLLMParams(GenericMishikaLLMParams):
    # This class is used to update the MishikaLLM_Params
...
class updateDeployment(BaseModel):
    ...
    mishikallm_params: Optional[updateMishikaLLMParams] = None
    model_info: Optional[ModelInfo] = None

    model_config = ConfigDict(protected_namespaces=())


class MishikaLLMParamsTypedDict(TypedDict, total=False):
    model: str
...
class DeploymentTypedDict(TypedDict, total=False):
    ...
    mishikallm_params: Required[MishikaLLMParamsTypedDict]
    model_info: dict
    ...
    def __init__(
        ...
        **params,
        ...
        for (
            ...
            field = getattr(mishikallm_params, key, None)
...
class AllowedFailsPolicy(BaseModel):
    ...
    https://docs.21t.cc/docs/exception_mapping
    """
...
class MishikaLLM_RouterFileObject(TypedDict, total=False):
    """
    Tracking the mishikallm params hash, used for mapping the file id to the right model
    """

    mishikallm_params_sensitive_credential_hash: str
