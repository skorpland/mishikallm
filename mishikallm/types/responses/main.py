...
class GenericResponseOutputItemContentAnnotation(BaseMishikaLLMOpenAIResponseObject):
...
class OutputText(BaseMishikaLLMOpenAIResponseObject):
...
class OutputFunctionToolCall(BaseMishikaLLMOpenAIResponseObject):
...
class GenericResponseOutputItem(BaseMishikaLLMOpenAIResponseObject):
    """
...
class DeleteResponseResult(BaseMishikaLLMOpenAIResponseObject):
    """
