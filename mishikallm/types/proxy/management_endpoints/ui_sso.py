...
from mishikallm.proxy._types import MishikaLLMPydanticObjectBase, MishikallmUserRoles
...
class DefaultTeamSSOParams(MishikaLLMPydanticObjectBase):
    """
    Default parameters to apply when a new team is automatically created by MishikaLLM via SSO Groups
    """
