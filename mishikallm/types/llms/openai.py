...
from mishikallm.types.llms.base import BaseMishikaLLMOpenAIResponseObject
...
):  # mishikallm wrapper on top of openai object for handling cached content
...
class ChatCompletionRequest(TypedDict, total=False):
    ...
    functions: List
    user: str
    metadata: dict  # mishikallm specific param
...
class MishikaLLMFineTuningJobCreate(FineTuningJobCreate):
...
class OutputTokensDetails(BaseMishikaLLMOpenAIResponseObject):
...
class InputTokensDetails(BaseMishikaLLMOpenAIResponseObject):
...
class ResponseAPIUsage(BaseMishikaLLMOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseMishikaLLMOpenAIResponseObject):
    id: str
    created_at: float
    error: Optional[dict]
...
class ResponseCreatedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class OutputItemAddedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: dict


class OutputItemDoneEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_DONE]
    output_index: int
    item: dict


class ContentPartAddedEvent(BaseMishikaLLMOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseMishikaLLMOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseMishikaLLMOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseMishikaLLMOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseMishikaLLMOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseMishikaLLMOpenAIResponseObject):
...
class RefusalDoneEvent(BaseMishikaLLMOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseMishikaLLMOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseMishikaLLMOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseMishikaLLMOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class ErrorEvent(BaseMishikaLLMOpenAIResponseObject):
...
class GenericEvent(BaseMishikaLLMOpenAIResponseObject):
    type: str
...
class OpenAIModerationResult(BaseMishikaLLMOpenAIResponseObject):
...
class OpenAIModerationResponse(BaseMishikaLLMOpenAIResponseObject):
    """
