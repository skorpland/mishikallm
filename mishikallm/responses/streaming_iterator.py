...
from mishikallm.constants import STREAM_SSE_DONE_STRING
...
class BaseResponsesAPIStreamingIterator:
    ...
    def __init__(
        ...
        # set request kwargs
        self.mishikallm_metadata = mishikallm_metadata
    ...
    def _process_chunk(self, chunk) -> Optional[ResponsesAPIStreamingResponse]:
        ...
        try:
            ...
            if isinstance(parsed_chunk, dict):
                ...
                # if "response" in parsed_chunk, then encode mishikallm specific information like custom_llm_provider
                response_object = getattr(openai_responses_api_chunk, "response", None)
                if response_object:
                    response = ResponsesAPIRequestUtils._update_responses_api_response_id_with_model_id(
                        responses_api_response=response_object,
                        mishikallm_metadata=self.mishikallm_metadata,
