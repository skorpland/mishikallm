...
from mishikallm.types.responses.main import DecodedResponseId
from mishikallm.types.utils import SpecialEnums, Usage
...
class ResponsesAPIRequestUtils:
    ...
    def get_optional_params_responses_api(
        ...
        mapped_params = responses_api_provider_config.map_openai_params(
            ...
            model=model,
            drop_params=mishikallm.drop_params,
        )
    ...
    def get_requested_response_api_optional_param(
        ...
        # decode previous_response_id if it's a mishikallm encoded id
    ...
    def _update_responses_api_response_id_with_model_id(
        ...
        """
        mishikallm_metadata = mishikallm_metadata or {}
        model_info: Dict[str, Any] = mishikallm_metadata.get("model_info", {}) or {}
    ...
    def _build_responses_api_response_id(
        ...
        assembled_id: str = str(
            SpecialEnums.MISHIKALLM_MANAGED_RESPONSE_COMPLETE_STR.value
    ...
    def _decode_responses_api_response_id(
        ...
        try:
            ...
            # Format: mishikallm:custom_llm_provider:{};model_id:{};response_id:{}
            custom_llm_provider = None
            model_id = None
            ...
            if (
                ...
                custom_llm_provider = custom_llm_provider_part.replace(
                    "mishikallm:custom_llm_provider:", ""
                )
    ...
    def decode_previous_response_id_to_original_previous_response_id(
        ...
        Why?
            - MishikaLLM encodes the `custom_llm_provider` and `model_id` into the `previous_response_id` this helps with maintaining session consistency when load balancing multiple deployments of the same model.
            - We cannot send the mishikallm encoded b64 to the upstream llm api, hence we decode it to the original `previous_response_id`
