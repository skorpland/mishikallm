...
import mishikallm
from mishikallm.constants import request_timeout
...
from mishikallm.responses.mishikallm_completion_transformation.handler import (
    MishikaLLMCompletionTransformationHandler,
)
...
from mishikallm.utils import ProviderConfigManager, client
...
mishikallm_completion_transformation_handler = MishikaLLMCompletionTransformationHandler()
#################################################
...
async def aresponses(
    ...
    **kwargs,
    ...
    try:
        ...
        raise mishikallm.exception_type(
            model=model,
            custom_llm_provider=custom_llm_provider,
    ...
    try:
        ...
        responses_api_provider_config: Optional[BaseResponsesAPIConfig] = (
            ProviderConfigManager.get_provider_responses_api_config(
                model=model,
                provider=mishikallm.LlmProviders(custom_llm_provider),
            )
        )
        ...
        if responses_api_provider_config is None:
            return mishikallm_completion_transformation_handler.response_api_handler(
                model=model,
                input=input,
