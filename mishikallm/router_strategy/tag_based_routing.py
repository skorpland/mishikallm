...
async def get_deployments_for_tag(
    ...
    if "metadata" in request_kwargs:
        ...
        if request_tags:
            ...
            for deployment in healthy_deployments:
                deployment_mishikallm_params = deployment.get("mishikallm_params")
                deployment_tags = deployment_mishikallm_params.get("tags")
    ...
    for deployment in healthy_deployments:
        if "default" in deployment.get("mishikallm_params", {}).get("tags", []):
...
def _get_tags_from_request_kwargs(
    ...
    elif "mishikallm_params" in request_kwargs:
        mishikallm_params = request_kwargs["mishikallm_params"]
