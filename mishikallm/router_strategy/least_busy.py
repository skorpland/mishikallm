...
#   - use mishikallm.input_callbacks to log when a request is just about to be made to a model - {"deployment-id": traffic}
#   - use mishikallm.success + failure callbacks to log when a request completed
