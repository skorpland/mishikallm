...
from mishikallm.types.utils import MishikaLLMPydanticObjectBase
...
class LowestLatencyLoggingHandler(CustomLogger):
    ...
    async def async_log_failure_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if isinstance(_exception, mishikallm.Timeout):
                if kwargs["mishikallm_params"].get("metadata") is None:
                    pass
                else:
                    model_group = kwargs["mishikallm_params"]["metadata"].get(
    ...
    async def async_log_success_event(  # noqa: PLR0915
        ...
        try:
            ...
            verbose_logger.exception(
                "mishikallm.router_strategy.lowest_latency.py::async_log_success_event(): Exception occured - {}".format(
                    str(e)
                )
            )
            pass
