...
from mishikallm.constants import SECRET_MANAGER_REFRESH_INTERVAL
from mishikallm.integrations.gcs_bucket.gcs_bucket_base import GCSBucketBase
from mishikallm.llms.custom_httpx.http_handler import _get_httpx_client
from mishikallm.proxy._types import CommonProxyErrors, KeyManagementSystem
...
class GoogleSecretManager(GCSBucketBase):
    def __init__(
        ...
        mishikallm.secret_manager_client = self
        mishikallm._key_management_system = KeyManagementSystem.GOOGLE_SECRET_MANAGER
