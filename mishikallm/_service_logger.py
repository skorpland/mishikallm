...
class ServiceLogging(CustomLogger):
    """
    Separate class used for monitoring health of mishikallm-adjacent services (redis/postgres).
    """
    ...
    def __init__(self, mock_testing: bool = False) -> None:
        ...
        if "prometheus_system" in mishikallm.service_callback:
    ...
    async def async_service_success_hook(
        ...
        for callback in mishikallm.service_callback:
    ...
    async def async_post_call_failure_hook(
        ...
        """
        Hook to track failed mishikallm-service calls
        """
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        """
        Hook to track latency for mishikallm proxy llm api calls
        """
        try:
            ...
            await self.async_service_success_hook(
                service=ServiceTypes.MISHIKALLM,
                duration=_duration,
