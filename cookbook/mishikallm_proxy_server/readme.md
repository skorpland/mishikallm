...
- **Logging** - Log Requests, Responses and Errors to `Supabase`, `Posthog`, `Mixpanel`, `Sentry`, `Lunary`,`Athina`, `Helicone` (Any of the supported providers here: https://mishikallm.readthedocs.io/en/latest/advanced/
...
- `model` (string, required): ID of the model to use for chat completions. See all supported models [here]: (https://mishikallm.readthedocs.io/en/latest/supported/):
