...
# see supported models / keys here: https://mishikallm.readthedocs.io/en/latest/supported/
######### ENVIRONMENT VARIABLES ##########
verbose = True

# mishikallm.caching_with_models = True # CACHING: caching_with_models Keys in the cache are messages + model. - to learn more: https://docs.21t.cc/docs/caching/
######### PROMPT LOGGING ##########
...
# set callbacks
mishikallm.success_callback = ["promptlayer"]
############ HELPER FUNCTIONS ###################################
