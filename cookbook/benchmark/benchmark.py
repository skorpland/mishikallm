...
# select any LLM listed here: https://docs.21t.cc/docs/providers
models = ["gpt-3.5-turbo", "claude-2"]

# Enter LLM API keys
# https://docs.21t.cc/docs/providers
os.environ["OPENAI_API_KEY"] = ""
os.environ["ANTHROPIC_API_KEY"] = ""

# List of questions to benchmark (replace with your questions)
questions = ["When will skorpland IPO?", "When will MishikaLLM hit $100M ARR?"]

# Enter your system prompt here
system_prompt = """
You are MishikaLLMs helpful assistant
"""
