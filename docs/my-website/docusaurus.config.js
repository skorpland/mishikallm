  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Twitter',
                href: 'https://twitter.com/MishikaLLM',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} mishikaLLM`,
      },
      prism: {
