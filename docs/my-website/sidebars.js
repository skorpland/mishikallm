...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    {
      type: "category",
      label: "MishikaLLM Proxy Server",
      link: {
        type: "generated-index",
        title: "MishikaLLM Proxy Server (LLM Gateway)",
      ...
      items: [
        ...
        },
        {
          ...
          href: "https://mishikallm-api.up.railway.app/",
        },
        "proxy/enterprise",
        ...
        },
        {
          ...
          href: "https://docs.21t.cc/docs/routing-load-balancing",
        },
        {
          type: "category",
    ...
    },
    {
      ...
      link: {
        ...
        title: "Providers",
        description:
          "Learn how to deploy + call models from different providers on MishikaLLM",
        slug: "/providers",
      },
      items: [
        {
    ...
    },
    {
      ...
      items: [
...

        {
          ...
          items: [
            "files_endpoints",
            "proxy/mishikallm_managed_files",
          ],
        },
        "batches",
        "realtime",
    ...
    },
    {
      ...
      items: [
        ...
        'tutorials/mishikallm_proxy_aporia',
        {
          type: "category",
          label: "MishikaLLM Python SDK Tutorials",
          items: [
            ...
            "tutorials/TogetherAI_mishikaLLM",
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "❤️ 🚅 Projects built on MishikaLLM",
          link: {
            type: "generated-index",
            title: "Projects built on MishikaLLM",
            description:
              "Learn how to deploy + call models from different providers on MishikaLLM",
            slug: "/project",
          },
