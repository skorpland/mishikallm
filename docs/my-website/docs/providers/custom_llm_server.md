...
Call your custom torch-serve / internal LLM APIs via MishikaLLM
...
from mishikallm.types.utils import GenericStreamingChunk, ModelResponse
from mishikallm import CustomLLM, completion, acompletion
...
```python
import mishikallm
from mishikallm import CustomLLM
...
```python
from mishikallm.types.utils import GenericStreamingChunk, ModelResponse, ImageResponse
from typing import Iterator, AsyncIterator, Any, Optional, Union
from mishikallm.llms.base import BaseLLM
