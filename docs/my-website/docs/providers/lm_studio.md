...
**We support ALL LM Studio models, just set `model=lm_studio/<any-model-on-lmstudio>` as a prefix when sending mishikallm requests**
...
| Provider Route on MishikaLLM | `lm_studio/` |
...
Here's how to call a LM Studio model with the MishikaLLM Proxy Server
