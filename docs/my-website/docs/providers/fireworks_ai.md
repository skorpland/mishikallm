...
| Provider Route on MishikaLLM | `fireworks_ai/` |
...
This guide explains how to integrate MishikaLLM with Fireworks AI. You can connect to Fireworks AI in three main ways:
...
```python
mishikallm.disable_add_transform_inline_image_block = True
```
...
| Model Name            | Function Call                                                   |
|-----------------------|-----------------------------------------------------------------|
| fireworks_ai/nomic-ai/nomic-embed-text-v1.5 | `response = mishikallm.embedding(model="fireworks_ai/nomic-ai/nomic-embed-text-v1.5", input=input_text)` |
| fireworks_ai/nomic-ai/nomic-embed-text-v1 | `response = mishikallm.embedding(model="fireworks_ai/nomic-ai/nomic-embed-text-v1", input=input_text)` |
| fireworks_ai/WhereIsAI/UAE-Large-V1 | `response = mishikallm.embedding(model="fireworks_ai/WhereIsAI/UAE-Large-V1", input=input_text)` |
| fireworks_ai/thenlper/gte-large | `response = mishikallm.embedding(model="fireworks_ai/thenlper/gte-large", input=input_text)` |
| fireworks_ai/thenlper/gte-base | `response = mishikallm.embedding(model="fireworks_ai/thenlper/gte-base", input=input_text)` |
