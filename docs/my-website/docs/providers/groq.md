...
**We support ALL Groq models, just set `model=groq/<any-model-on-groq>` as a prefix when sending mishikallm requests**
...
Make request to mishikallm proxy
...
transcript = mishikallm.transcription(
