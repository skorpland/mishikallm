...
```python
mishikallm.success_callback = ["athina"]
```
...
- [Website 💻](https://athina.ai/?utm_source=mishikallm&utm_medium=website)
- [Docs 📖](https://docs.athina.ai/?utm_source=mishikallm&utm_medium=website)
