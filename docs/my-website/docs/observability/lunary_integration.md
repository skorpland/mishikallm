...
response = completion(
  ...
  user="ishaan_mishikallm"
)
```

### Usage with LangChain ChatMishikaLLM 
```python
import os
...
You can use Lunary to manage [prompt templates](https://lunary.ai/docs/features/prompts) and use them across all your LLM providers with MishikaLLM.
...
You can find more details about the different ways of making requests to the MishikaLLM proxy on [this page](https://docs.21t.cc/docs/proxy/user_keys)
