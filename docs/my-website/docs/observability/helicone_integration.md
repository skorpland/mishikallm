...
## Using Helicone with MishikaLLM

MishikaLLM provides `success_callbacks` and `failure_callbacks`, allowing you to easily log data to Helicone based on the status of your responses.
...
There are two main approaches to integrate Helicone with MishikaLLM:
...
1. Set Helicone as your base URL via: mishikallm.api_base
2. Pass in Helicone request headers via: mishikallm.metadata
...
> By utilizing these headers and metadata options, you can gain deeper insights into your LLM usage, optimize performance, and better manage your AI workflows with Helicone and MishikaLLM.
