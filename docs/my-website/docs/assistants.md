...
assistant = mishikallm.create_assistants(
...
### ASYNC USAGE ### 
# assistant = await mishikallm.acreate_assistants(
#             custom_llm_provider="openai",
#             model="gpt-4-turbo",
#             instructions="You are a personal math tutor. When asked a question, write and run Python code to answer the question.",
#             name="Math Tutor",
...
```python
from mishikallm import get_assistants, aget_assistants
import os 
...
```python
from mishikallm import create_thread, acreate_thread
import os 
...
```python
from mishikallm import create_thread, get_thread, aget_thread, add_message, a_add_message
import os 
...
```python
from mishikallm import get_assistants, create_thread, add_message, run_thread, arun_thread
import os 
...
```python
from mishikallm import run_thread_stream 
import os
...
## [👉 Proxy API Reference](https://mishikallm-api.up.railway.app/#/assistants)
