...
Trying to do batch completion on MishikaLLM Proxy ? Go here: https://docs.21t.cc/docs/proxy/user_keys#beta-batch-completions---pass-model-as-list

:::

## Send multiple completion calls to 1 model

In the batch_completion method, you provide a list of `messages` where each sub-list of messages is passed to `mishikallm.completion()`, allowing you to process multiple prompts efficiently in a single API call.

<a target="_blank" href="https://colab.research.google.com/github/skorpland/mishikallm/blob/main/cookbook/MishikaLLM_batch_completion.ipynb">
...
import mishikallm
import os
from mishikallm import batch_completion_models
...
import mishikallm
import os
from mishikallm import batch_completion_models_all_responses
