...
- via provider-specific config variable (e.g. `mishikallm.OpenAIConfig()`). 
...
## SET MAX TOKENS - via config
mishikallm.TogetherAIConfig(max_tokens_to_sample=200)
response_2 = mishikallm.completion(
            model="together_ai/togethercomputer/llama-2-70b-chat",
            messages=[{ "content": "Hello, how are you?","role": "user"}],
        )
...
## SET MAX TOKENS - via config
mishikallm.OllamConfig(num_predict=200)
response_2 = mishikallm.completion(
            model="ollama/llama2",
            messages=[{ "content": "Hello, how are you?","role": "user"}],
        )
...
## SET MAX TOKENS - via config
mishikallm.PalmConfig(maxOutputTokens=10)
response_2 = mishikallm.completion(
            model="palm/chat-bison",
            messages=[{ "content": "Hello, how are you?","role": "user"}],
        )
...
## SET MAX TOKENS - via config
mishikallm.AI21Config(maxOutputTokens=10)
response_2 = mishikallm.completion(
            model="j2-mid",
            messages=[{ "content": "Hello, how are you?","role": "user"}],
        )
