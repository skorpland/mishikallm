...
MishikaLLM Proxy is **OpenAI-Compatible**, and supports:
* /chat/completions 
* /embeddings
* /completions 
* /image/generations 
...
* /audio/speech
* [Assistants API endpoints](https://docs.21t.cc/docs/assistants)
* [Batches API endpoints](https://docs.21t.cc/docs/batches)
* [Fine-Tuning API endpoints](https://docs.21t.cc/docs/fine_tuning)

MishikaLLM Proxy is **Azure OpenAI-compatible**:
* /chat/completions
* /completions
* /embeddings 

MishikaLLM Proxy is **Anthropic-compatible**: 
* /messages 

MishikaLLM Proxy is **Vertex AI compatible**:
...
my_proxy_api_key = "" # e.g. sk-1234 - MISHIKALLM KEY
my_proxy_base_url = "" # e.g. http://0.0.0.0:4000 - MISHIKALLM PROXY BASE URL

# This enables response_model keyword
# from client.chat.completions.create
## WORKS ACROSS OPENAI/ANTHROPIC/VERTEXAI/ETC. - all MISHIKALLM SUPPORTED MODELS!
...
👉 **[Here's how to use mishikallm proxy with Vertex, boto3, Anthropic SDK - in the native format](../pass_through/vertex_ai.md)**
...
This same request will be sent to the following model groups on the [mishikallm proxy config.yaml](https://docs.21t.cc/docs/proxy/configs)
- `model_name="llama3"`
...
curl --location 'http://localhost:4000/chat/completions' \
    ...
    "messages": [
        {
        "role": "user",
        "content": "is mishikallm getting better"
        }
    ]
}'
```
