...
[More info about Prometheus metrics here](https://docs.21t.cc/docs/proxy/prometheus)
...
```shell
mishikallm_remaining_team_budget_metric{team_alias="QA Prod Bot",team_id="de35b29e-6ca8-4f47-b804-2b79d07aa99a"} 9.699999999999992e-06
```
...
Dynamically allocate TPM/RPM quota to api keys, based on active keys in that minute. [**See Code**](https://github.com/skorpland/mishikallm/blob/9bffa9a48e610cc6886fc2dce5c1815aeae2ad46/mishikallm/proxy/hooks/dynamic_rate_limiter.py#L125)
...
general_settings:
  master_key: sk-1234 # OR set `MISHIKALLM_MASTER_KEY=".."` in your .env
