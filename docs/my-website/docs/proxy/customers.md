...
Set customer budgets (e.g. monthly budgets, tpm/rpm limits) on MishikaLLM Proxy 
...
Use the `/budget/new` endpoint for creating a new budget. [API Reference](https://mishikallm-api.up.railway.app/#/budget%20management/new_budget_budget_new_post)
