...
class myCustomGuardrail(CustomGuardrail):
    ...
    async def async_post_call_streaming_iterator_hook(
        ...
        See Aim guardrail implementation for an example - https://github.com/BerriAI/mishikallm/blob/d0e022cfacb8e9ebc5409bb652059b6fd97b45c0/mishikallm/proxy/guardrails/guardrail_hooks/aim.py#L168
