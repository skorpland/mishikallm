...
[**Example** ad-hoc recognizer](../../../../mishikallm/proxy/hooks/example_presidio_ad_hoc_recognize)

#### Define ad-hoc recognizer on your MishikaLLM config.yaml 
...
1. Define mode: `logging_only` on your MishikaLLM config.yaml 
