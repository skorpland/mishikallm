...
### [API Reference](https://mishikallm-api.up.railway.app/#/key%20management/generate_key_fn_key_generate_post)

## **Restrict models by `team_id`**
`mishikallm-dev` can only access `azure-gpt-3.5`
...
```shell
{"error":{"message":"Invalid model for team mishikallm-dev: BEDROCK_GROUP.  Valid models for team are: ['azure-gpt-3.5']\n\n\nTraceback (most recent call last):\n  File \"/Users/ishaanjaffer/Github/mishikallm/mishikallm/proxy/proxy_server.py\", line 2298, in chat_completion\n    _is_valid_team_configs(\n  File \"/Users/ishaanjaffer/Github/mishikallm/mishikallm/proxy/utils.py\", line 1296, in _is_valid_team_configs\n    raise Exception(\nException: Invalid model for team mishikallm-dev: BEDROCK_GROUP.  Valid models for team are: ['azure-gpt-3.5']\n\n","type":"None","param":"None","code":500}}%            
```         

### [API Reference](https://mishikallm-api.up.railway.app/#/team%20management/new_team_team_new_post)
...
Get a trial key [here](https://21t.cc/#trial)
:::
