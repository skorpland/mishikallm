...
You can do `langfuse/<mishikallm_model_name>`
...
These are the params you can pass to the `mishikallm.completion` function in SDK and `mishikallm_params` in config.yaml
