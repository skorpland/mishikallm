# Reliability test Multiple LLM Providers with MishikaLLM
...
```python
!pip install mishikallm python-dotenv
```


```python
import mishikallm
from mishikallm import load_test_model, testing_batch_completion
import time
```
...
![png](mishikallm_Test_Multiple_Providers_files/mishikallm_Test_Multiple_Providers_11_0.png)
...
![png](mishikallm_Test_Multiple_Providers_files/mishikallm_Test_Multiple_Providers_14_0.png)
