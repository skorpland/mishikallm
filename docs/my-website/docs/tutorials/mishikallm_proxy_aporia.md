...
# Aporia Guardrails with MishikaLLM Gateway

In this tutorial we will use MishikaLLM AI Gateway with Aporia to detect PII in requests and profanity in responses
...
## 2. Define Guardrails on your MishikaLLM config.yaml 
