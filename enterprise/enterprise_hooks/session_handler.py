...
import json
from mishikallm.types.utils import ModelResponse, Message
...
from mishikallm.responses.mishikallm_completion_transformation.transformation import ChatCompletionSession
...
class _ENTERPRISE_ResponsesSessionHandler:
    ...
    async def get_chat_completion_message_history_for_previous_response_id(
        ...
        """
        from mishikallm.responses.mishikallm_completion_transformation.transformation import MishikaLLMCompletionResponsesConfig
        ...
        mishikallm_session_id: Optional[str] = None
        if len(all_spend_logs) > 0:
            mishikallm_session_id = all_spend_logs[0].get("session_id")
        ...
        for spend_log in all_spend_logs:
            ...
            if response_input_param:
                chat_completion_messages = MishikaLLMCompletionResponsesConfig.transform_responses_api_input_to_messages(
        ...
        return ChatCompletionSession(
            ...
            mishikallm_session_id=mishikallm_session_id
        )
