...
from mishikallm.proxy._types import CommonProxyErrors, UserAPIKeyAuth
from mishikallm.proxy.auth.auth_utils import (
    get_key_model_rpm_limit,
    get_key_model_tpm_limit,
)
from mishikallm.router_strategy.base_routing_strategy import BaseRoutingStrategy
...
class _PROXY_MaxParallelRequestsHandler(BaseRoutingStrategy, CustomLogger):
    ...
    async def _update_usage_in_cache_post_call(
        ...
        model: Optional[str],
        total_tokens: int,
        mishikallm_parent_otel_span: Union[Span, None] = None,
    ):
        increment_list: List[Tuple[str, int]] = []
        increment_value_by_group = {
            "request_count": -1,
    ...
    async def async_log_success_event(  # noqa: PLR0915
        ...
        try:
            ...
            user_api_key_end_user_id = kwargs.get("user") or kwargs["mishikallm_params"][
                "metadata"
