...
export default function Onboarding() {
  ...
  const handleSubmit = (formValues: Record<string, any>) => {
    ...
    claimOnboardingToken(
      ...
      let mishikallm_dashboard_ui = "/ui/";
      mishikallm_dashboard_ui += "?login=success";

      // set cookie "token" to jwtToken
      document.cookie = "token=" + jwtToken;
      console.log("redirecting to:", mishikallm_dashboard_ui);

      window.location.href = mishikallm_dashboard_ui;
    });
  ...
  return (
    <div className="mx-auto w-full max-w-md mt-10">
      <Card>
        <Title className="text-sm mb-5 text-center">🚅 MishikaLLM</Title>
