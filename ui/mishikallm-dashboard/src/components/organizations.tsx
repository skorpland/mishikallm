...
const OrganizationsTable: React.FC<OrganizationsTableProps> = ({
  ...
  if (!premiumUser) {
    return (
      <div>
        <Text>This is a MishikaLLM Enterprise feature, and requires a valid key to use. Get a trial key <a href="https://21t.cc/pricing" target="_blank" rel="noopener noreferrer">here</a>.</Text>
      </div>
    );
  }
                      ...
                      ? organizations
                          ...
                          .map((org: Organization) => (
                            <TableRow key={org.organization_id}>
                              ...
                              <TableCell>
                                {org.mishikallm_budget_table?.max_budget !== null && org.mishikallm_budget_table?.max_budget !== undefined ? org.mishikallm_budget_table?.max_budget : "No limit"}
                              </TableCell>
                              <TableCell>
                              ...
                              <TableCell>
                                <Text>
                                  TPM: {org.mishikallm_budget_table?.tpm_limit ? org.mishikallm_budget_table?.tpm_limit : "Unlimited"}
                                  <br />
                                  RPM: {org.mishikallm_budget_table?.rpm_limit ? org.mishikallm_budget_table?.rpm_limit : "Unlimited"}
                                </Text>
                              </TableCell>
                              <TableCell>
