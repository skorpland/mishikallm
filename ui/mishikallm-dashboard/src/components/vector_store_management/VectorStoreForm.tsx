  ...
  const handleCreate = async (formValues: any) => {
    ...
    try {
      ...
      await vectorStoreCreateCall(accessToken, {
        ...
        mishikallm_credential_name: formValues.mishikallm_credential_name,
      });
      ...
      >
        ...
        <Form.Item
          label={
              <span>
                  Vector Store Name{' '}
                  <Tooltip title="Custom name you want to give to the vector store, this name will be rendered on the MishikaLLM UI">
                      <InfoCircleOutlined style={{ marginLeft: '4px' }} />
                  </Tooltip>
              </span>
          }
