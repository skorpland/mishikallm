...
export const columns = (
  ...
  {
    header: "MishikaLLM Model Name",
    accessorKey: "mishikallm_model_name",
    cell: ({ row }) => {
      const model = row.original;
      return (
        <Tooltip title={model.mishikallm_model_name}>
          <div className="text-xs truncate whitespace-nowrap">
  ...
  {
    header: "Credentials",
    accessorKey: "mishikallm_credential_name",
    cell: ({ row }) => {
      const model = row.original;
      return model.mishikallm_params && model.mishikallm_params.mishikallm_credential_name ? (
        <div className="overflow-hidden">
          <Tooltip title={model.mishikallm_params.mishikallm_credential_name}>
            {model.mishikallm_params.mishikallm_credential_name.slice(0, 7)}...
          </Tooltip>
        </div>
      ) : (
