    ...
    if (providerKey && typeof modelMap === "object") {
      Object.entries(modelMap).forEach(([key, value]) => {
        if (
          value !== null &&
          typeof value === "object" &&
          "mishikallm_provider" in (value as object) &&
          ((value as any)["mishikallm_provider"] === custom_llm_provider ||
            (value as any)["mishikallm_provider"].includes(custom_llm_provider))
        ) {
      ...
      if (providerKey == Providers.Cohere) {
        ...
        Object.entries(modelMap).forEach(([key, value]) => {
          if (
            ...
            typeof value === "object" &&
            "mishikallm_provider" in (value as object) &&
            ((value as any)["mishikallm_provider"] === "cohere")
          ) {
            providerModels.push(key);
          }
        });
