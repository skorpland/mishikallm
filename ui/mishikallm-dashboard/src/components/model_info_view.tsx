...
export default function ModelInfoView({ 
  ...
  const usingExistingCredential = modelData.mishikallm_params?.mishikallm_credential_name != null && modelData.mishikallm_params?.mishikallm_credential_name != undefined;
  console.log("usingExistingCredential, ", usingExistingCredential);
  console.log("modelData.mishikallm_params.mishikallm_credential_name, ", modelData.mishikallm_params.mishikallm_credential_name);
  ...
  useEffect(() => {
    ...
    const getModelInfo = async () => {
      ...
      if (specificModelData?.mishikallm_params?.cache_control_injection_points) {
  ...
  const handleReuseCredential = async (values: any) => {
    ...
    let credentialItem = {
      ...
      model_id: modelId,
      credential_info: {
        "custom_llm_provider": localModelData.mishikallm_params?.custom_llm_provider,
      }
    }
  ...
  const handleModelUpdate = async (values: any) => {
    try {
      ...
      let updatedMishikallmParams = {
        ...localModelData.mishikallm_params,
        model: values.mishikallm_model_name,
      ...
      if (values.cache_control && values.cache_control_injection_points?.length > 0) {
        updatedMishikallmParams.cache_control_injection_points = values.cache_control_injection_points;
      } else {
        delete updatedMishikallmParams.cache_control_injection_points;
      }
      
      const updateData = {
        model_name: values.model_name,
        mishikallm_params: updatedMishikallmParams,
        model_info: {
          id: modelId,
        }
      };
      ...
      const updatedModelData = {
        ...localModelData,
        model_name: values.model_name,
        mishikallm_model_name: values.mishikallm_model_name,
        mishikallm_params: updatedMishikallmParams
      };
  ...
  return (
    <div className="p-4">
        ...
        <TabPanels>
          <TabPanel>
            ...
            <Grid numItems={1} numItemsSm={2} numItemsLg={3} className="gap-6 mb-6">
              ...
              <Card>
                <Text>MishikaLLM Model</Text>
                <pre>
                  <Title>{modelData.mishikallm_model_name || "Not Set"}</Title>
                </pre>
              </Card>
              <Card>
                <Text>Pricing</Text>
            ...
            <Card>
              ...
              {localModelData ? (
                <Form
                  ...
                  mishikallm_model_name: localModelData.mishikallm_model_name,
                  api_base: localModelData.mishikallm_params.api_base,
                  custom_llm_provider: localModelData.mishikallm_params.custom_llm_provider,
                  organization: localModelData.mishikallm_params.organization,
                  tpm: localModelData.mishikallm_params.tpm,
                  rpm: localModelData.mishikallm_params.rpm,
                  max_retries: localModelData.mishikallm_params.max_retries,
                  timeout: localModelData.mishikallm_params.timeout,
                  stream_timeout: localModelData.mishikallm_params.stream_timeout,
                  input_cost: localModelData.mishikallm_params.input_cost_per_token ? 
                    (localModelData.mishikallm_params.input_cost_per_token * 1_000_000) : localModelData.model_info?.input_cost_per_token * 1_000_000 || null,
                  output_cost: localModelData.mishikallm_params?.output_cost_per_token ? 
                    (localModelData.mishikallm_params.output_cost_per_token * 1_000_000) : localModelData.model_info?.output_cost_per_token * 1_000_000 || null,
                  cache_control: localModelData.mishikallm_params?.cache_control_injection_points ? true : false,
                  cache_control_injection_points: localModelData.mishikallm_params?.cache_control_injection_points || [],
                }}
                layout="vertical"
              ...
              >
                <div className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div>
                      <Text className="font-medium">MishikaLLM Model Name</Text>
                      {isEditing ? (
                        <Form.Item name="mishikallm_model_name" className="mb-0">
                          <TextInput placeholder="Enter MishikaLLM model name" />
                        </Form.Item>
                      ) : (
                        <div className="mt-1 p-2 bg-gray-50 rounded">{localModelData.mishikallm_model_name}</div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData?.mishikallm_params?.input_cost_per_token 
                            ? (localModelData.mishikallm_params?.input_cost_per_token * 1_000_000).toFixed(4) 
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData?.mishikallm_params?.output_cost_per_token 
                            ? (localModelData.mishikallm_params.output_cost_per_token * 1_000_000).toFixed(4) 
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.api_base || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.custom_llm_provider || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.organization || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.tpm || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.rpm || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.max_retries || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.timeout || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {isEditing ? (
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.stream_timeout || "Not Set"}
                        </div>
                      )}
                    </div>
                    ...
                    {isEditing ? (
                      ...
                      <div>
                        ...
                        <div className="mt-1 p-2 bg-gray-50 rounded">
                          {localModelData.mishikallm_params?.cache_control_injection_points ? (
                            <div>
                              <p>Enabled</p>
                              <div className="mt-2">
                                {localModelData.mishikallm_params.cache_control_injection_points.map((point: any, i: number) => (
      ...
      !usingExistingCredential ? (
        ...
        >
          <Text>{modelData.mishikallm_params.mishikallm_credential_name}</Text>
        </Modal>
      )}
    </div>
  );
