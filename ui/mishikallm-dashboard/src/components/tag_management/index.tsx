      ...
      {selectedTagId ? (
        ...
        <div className="gap-2 p-8 h-[75vh] w-full mt-2">
          ...
          <Text className="mb-4">
            ...
            <p>You can use tags to restrict the usage of certain LLMs based on tags passed in the request. Read more about tag routing <a href="https://docs.21t.cc/docs/proxy/tag_routing" target="_blank" rel="noopener noreferrer">here</a>.</p>
          </Text>
