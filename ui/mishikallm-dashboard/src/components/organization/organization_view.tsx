        ...
        <TabPanels>
          ...
          <Grid numItems={1} numItemsSm={2} numItemsLg={3} className="gap-6">
            ...
            <Card>
                ...
                <Text>of {orgData.mishikallm_budget_table.max_budget === null ? "Unlimited" : `$${orgData.mishikallm_budget_table.max_budget}`}</Text>
                {orgData.mishikallm_budget_table.budget_duration && (
                    <Text className="text-gray-500">Reset: {orgData.mishikallm_budget_table.budget_duration}</Text>
                )}
                </div>
            </Card>
            ...
            <Card>
                ...
                <div className="mt-2">
                <Text>TPM: {orgData.mishikallm_budget_table.tpm_limit || 'Unlimited'}</Text>
                <Text>RPM: {orgData.mishikallm_budget_table.rpm_limit || 'Unlimited'}</Text>
                {orgData.mishikallm_budget_table.max_parallel_requests && (
                    <Text>Max Parallel Requests: {orgData.mishikallm_budget_table.max_parallel_requests}</Text>
                )}
                </div>
            </Card>
              ...
              {isEditing ? (
                <Form
                  ...
                  initialValues={{
                    ...
                    tpm_limit: orgData.mishikallm_budget_table.tpm_limit,
                    rpm_limit: orgData.mishikallm_budget_table.rpm_limit,
                    max_budget: orgData.mishikallm_budget_table.max_budget,
                    budget_duration: orgData.mishikallm_budget_table.budget_duration,
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div>TPM: {orgData.mishikallm_budget_table.tpm_limit || 'Unlimited'}</div>
                    <div>RPM: {orgData.mishikallm_budget_table.rpm_limit || 'Unlimited'}</div>
                  </div>
                  <div>
                    <Text className="font-medium">Budget</Text>
                    <div>Max: {orgData.mishikallm_budget_table.max_budget !== null ? `$${orgData.mishikallm_budget_table.max_budget}` : 'No Limit'}</div>
                    <div>Reset: {orgData.mishikallm_budget_table.budget_duration || 'Never'}</div>
                  </div>
                </div>
              )}
            </Card>
