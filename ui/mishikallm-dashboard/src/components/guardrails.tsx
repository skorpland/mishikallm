...
const GuardrailsPanel: React.FC<GuardrailsPanelProps> = ({ accessToken }) => {
  ...
  return (
    <div className="w-full mx-auto flex-auto overflow-y-auto m-8 p-2">
        ...
        <a 
            href="https://docs.21t.cc/docs/proxy/guardrails/quick_start" 
            target="_blank" 
