...
client = openai.OpenAI(
    ...
    base_url="http://0.0.0.0:4000" # MishikaLLM Proxy is OpenAI compatible, Read More: https://docs.21t.cc/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    engine="${selectedModel.model_group}",               # model_name on mishikallm proxy
    temperature=0.0,
...
print(response)
            ...
            {/* <p><strong>Additional Params:</strong> {JSON.stringify(selectedModel.mishikallm_params)}</p> */}
