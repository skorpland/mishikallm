...
export const createCredentialFromModel = (provider: string, modelData: any): CredentialItem => {
  ...
  providerFields.forEach(field => {
    const value = modelData.mishikallm_params[field.key];
...
const PROVIDER_CREDENTIAL_FIELDS: Record<Providers, ProviderCredentialField[]> = {
  ...
  [Providers.Azure]: [
    ...
    },
    {
      ...
      tooltip: "By default mishikallm will use the latest version. If you want to use a different version, you can specify it here"
    },
    {
      key: "base_model",
      label: "Base Model",
  ...
  [Providers.Azure_AI_Studio]: [
    {
      ...
      tooltip: "Enter your full Target URI from Azure Foundry here. Example:  https://mishikallm8397336933.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-10-21",
      required: true
    },
    {
      key: "api_key",
