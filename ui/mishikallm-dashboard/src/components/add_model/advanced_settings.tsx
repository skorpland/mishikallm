...
const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  const handlePassThroughChange = (checked: boolean) => {
    ...
    try {
      ...
      if (checked) {
        form.setFieldValue('mishikallm_extra_params', JSON.stringify({ use_in_pass_through: true }, null, 2));
      } else {
        form.setFieldValue('mishikallm_extra_params', '');
      }
    }
      ...
      <Accordion className="mt-2 mb-4">
        ...
        <AccordionBody>
          <div className="bg-white rounded-lg">
            ...
            <Form.Item
              ...
              tooltip={
                <span>
                  ...
                  <Link href="https://docs.21t.cc/docs/pass_through/vertex_ai" target="_blank">
                    Learn more
                  </Link>
                </span>
              }
            ...
            />
            <Form.Item
              label="MishikaLLM Params"
              name="mishikallm_extra_params"
              tooltip="Optional mishikallm params used for making a mishikallm.completion() call."
              className="mb-4 mt-4"
            ...
            <Row className="mb-4">
              ...
              <Col span={10}>
                <Text className="text-gray-600 text-sm">
                  Pass JSON of mishikallm supported params{" "}
                  <Link
                    href="https://docs.21t.cc/docs/completion/input"
                    target="_blank"
                  >
