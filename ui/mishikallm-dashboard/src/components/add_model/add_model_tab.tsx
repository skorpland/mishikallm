...
import MishikaLLMModelNameField from "./mishikallm_model_name";
        ...
        >
          <>
            ...
            <Row>
              ...
              <Col span={10}>
                <Text className="mb-5 mt-1">
                  <strong>Optional</strong> - MishikaLLM endpoint to use when health checking this model <Link href="https://docs.21t.cc/docs/proxy/health#health" target="_blank">Learn more</Link>
                </Text>
              </Col>
            </Row>
            ...
            <Form.Item
              ...
              name="mishikallm_credential_name"
            >
              <AntdSelect
                showSearch
            ...
            <Form.Item
              ...
              shouldUpdate={(prevValues, currentValues) => 
                prevValues.mishikallm_credential_name !== currentValues.mishikallm_credential_name ||
                prevValues.provider !== currentValues.provider
              }
            >
              {({ getFieldValue }) => {
                const credentialName = getFieldValue('mishikallm_credential_name');
