          ...
          if (selectedTeam.team_alias === "Default Team") {
            ...
            if (selectedTeam.team_memberships) {
              ...
              for (const member of selectedTeam.team_memberships) {
                if (member.user_id === userID && "max_budget" in member.mishikallm_budget_table && member.mishikallm_budget_table.max_budget !== null) {
                  setMaxBudget(member.mishikallm_budget_table.max_budget);
