...
const HealthCheckDetails: React.FC<{ response: any }> = ({ response }) => {
  ...
  let parsedMishikallmParams: any = {};
    ...
    if (response?.error) {
      try {
        ...
        errorDetails = {
          ...
          mishikallm_params: errorMessage?.mishikallm_cache_params || {},
          health_check_cache_params: errorMessage?.health_check_cache_params || {}
        };
        
        parsedMishikallmParams = deepParse(errorDetails.mishikallm_params) || {};
              ...
              <table className="w-full border-collapse">
                <tbody>
                  ...
                  <TableClickableErrorField
                    ...
                    value={String(parsedMishikallmParams?.type)}
                  />
                  <TableClickableErrorField
                    label="Ping Response"
                  ...
                  />
                  <TableClickableErrorField
                    label="mishikallm_settings.cache_params"
                    value={JSON.stringify(parsedMishikallmParams, null, 2)}
                  />
                  
                  {/* Redis Details Section */}
                  {parsedMishikallmParams?.type === "redis" && (
                    <>
              ...
              <pre className="whitespace-pre-wrap break-words overflow-auto max-h-[500px]">
                {(() => {
                  try {
                    const data = {
                      ...response,
                      mishikallm_cache_params: parsedMishikallmParams,
