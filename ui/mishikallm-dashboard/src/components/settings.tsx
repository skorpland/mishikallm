...
interface genericCallbackParams {
  ...
  mishikallm_callback_name: string  // what to send in request
  ui_callback_name: string // what to show on UI
  mishikallm_callback_params: string[] | null // known required params for this callback
}
...
const Settings: React.FC<SettingsPageProps> = ({
  ...
  const handleSelectedCallbackChange = (callbackObject: genericCallbackParams) => {
    ...
    setSelectedCallback(callbackObject.mishikallm_callback_name);

    console.log("all callbacks", allCallbacks);
    if (callbackObject && callbackObject.mishikallm_callback_params) {
      setSelectedCallbackParams(callbackObject.mishikallm_callback_params);
  ...
  return (
    <div className="w-full mx-4">
      ...
      <Text>
      <a href="https://docs.21t.cc/docs/proxy/email" target="_blank" style={{ color: "blue" }}> MishikaLLM Docs: email alerts</a> <br/>        
      </Text>
<div className="flex w-full">
  {alerts
    ...
    .map((alert, index) => (
      ...
      <a href="https://docs.21t.cc/docs/proxy/logging" className="mb-8 mt-4" target="_blank" style={{ color: "blue" }}> MishikaLLM Docs: Logging</a>
      ...
      <>
        ...
        {allCallbacks &&
          Object.values(allCallbacks).map((callback) => (
            <SelectItem 
            key={callback.mishikallm_callback_name} 
            value={callback.mishikallm_callback_name}
            >
