export type MishikaLLM_IncrementSpend = {
    key_transactions: Array<MishikaLLM_IncrementObject>, // [{"key": spend},..]
    user_transactions: Array<MishikaLLM_IncrementObject>, 
    team_transactions: Array<MishikaLLM_IncrementObject>,
    spend_logs_transactions: Array<MishikaLLM_SpendLogs>
}

export type MishikaLLM_IncrementObject = {
    key: string,
    spend: number
}

export type MishikaLLM_SpendLogs = {
