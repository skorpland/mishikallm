...
if __name__ == "__main__":
    ...
    # check if "Load Test MishikaLLM Proxy Results" exists
    existing_release_body = latest_release.body
    if "Load Test MishikaLLM Proxy Results" in latest_release.body:
        # find the "Load Test MishikaLLM Proxy Results" section and delete it
        start_index = latest_release.body.find("Load Test MishikaLLM Proxy Results")
    ...
    new_release_body = (
        ...
        + "\nHosted Proxy Alpha: https://calendly.com/d/4mp-gd3-k5k/mishikallm-1-1-onboarding-chat"
        + "\n\n"
        + "## Load Test MishikaLLM Proxy Results"
        + "\n\n"
        + markdown_table
    )
